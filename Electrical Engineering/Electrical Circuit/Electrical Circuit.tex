...
\item Complex-valued angular frequency $s$ (Hz = 1 / s)
...
\[v(s)=\mathcal{L}\{v(t)\}(s)=\int_0^{\infty}v(t)e^{-st}\dd{t},\]
\[i(s)=\mathcal{L}\{i(t)\}(s)=\int_0^{\infty}i(t)e^{-st}\dd{t},\]
to obtain its voltage $v(s)$ and current $i(\omega)$ as a function of frequency domain $s$.
