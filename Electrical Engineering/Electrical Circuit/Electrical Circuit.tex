...
\[v_L=e^{-\omega_0\zeta t}\qty(-\qty(v_C(0)+i(0)R)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{2\zeta^2-1}{2\zeta\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[v_C=e^{-\omega_0\zeta t}\qty(v_C(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{1}{2\zeta\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\begin{proof}
...
\[i=e^{-\omega_0\zeta t}\qty(i(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\qty(\frac{2v_C(0)}{R}+i(0))\frac{\zeta}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[\ba
v_C&=\frac{R}{2\zeta}e^{-\omega_0\zeta t}\qty(\qty(\qty(\frac{2v_C(0)}{R}+i(0))-i(0))\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(\qty(\frac{2v_C(0)}{R}+i(0))\frac{\zeta^2}{\sqrt{1-\zeta^2}}+i(0)\sqrt{1-\zeta^2})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\\
&=e^{-\omega_0\zeta t}\qty(v_C(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(\frac{2v_C(0)}{R}\frac{\zeta^2}{\sqrt{1-\zeta^2}}+i(0)\frac{\zeta^2}{\sqrt{1-\zeta^2}}+i(0)\frac{1-\zeta^2}{\sqrt{1-\zeta^2}})\frac{R}{2\zeta}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\\
&=e^{-\omega_0\zeta t}\qty(v_C(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{1}{2\zeta\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))
\ea\]
Check $i=C\dv{v_C}{t}$:
\[\ba
C\dv{v_C}{t}&=-\frac{2\zeta^2}{R}e^{-\omega_0\zeta t}\qty(v_C(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{1}{2\zeta\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))+\frac{2\zeta\sqrt{1-\zeta^2}}{R}e^{-\omega_0\zeta t}\qty(-v_C(0)\sin\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{1}{2\zeta\sqrt{1-\zeta^2}})\cos\qty(\omega_0\sqrt{1-\zeta^2}t))\\
...
&=e^{-\omega_0\zeta t}\qty(i(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\qty(\frac{2v_C(0)}{R}+i(0))\frac{\zeta}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\\
&=i
\ea\]
\[v_R=e^{-\omega_0\zeta t}\qty(i(0)R\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\qty(2v_C(0)+i(0)R)\frac{\zeta}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[v_L=e^{-\omega_0\zeta t}\qty(-\qty(v_C(0)+i(0)R)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(v_C(0)\frac{\zeta}{\sqrt{1-\zeta^2}}+i(0)R\frac{2\zeta^2-1}{2\zeta\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
...
\eit
Natural response (Laplace domain):
待change to no (s+\omega_0\zeta)
\[\ba
I&=\frac{i(0)LCs-v_C(0)C}{LCs^2+RCs+1}\\
&=\frac{i(0)\qty(s+\omega_0\zeta)-i(0)\omega_0\zeta-\frac{2v_C(0)\omega_0\zeta}{R}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_R&=\frac{i(0)RLCs-v_C(0)RC}{LCs^2+RCs+1}\\
&=\frac{i(0)R\qty(s+\omega_0\zeta)-i(0)R\omega_0\zeta-2v_C(0)\omega_0\zeta}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_L&=-\frac{\qty(i(0)R+v_C(0))LCs+i(0)L}{LCs^2+RCs+1}\\
&=-\frac{\qty(i(0)R+v_C(0))\qty(s+\omega_0\zeta)-\qty(i(0)R+v_C(0))\omega_0\zeta+\frac{i(0)R\omega_0}{2\zeta}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_C&=\frac{LCsv_C(0)+i(0)L+RCv_C(0)}{LCs^2+RCs+1}\\
&=\frac{i(0)\qty(s+\omega_0\zeta)-i(0)\omega_0\zeta-\frac{2v_C(0)\omega_0\zeta}{R}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\begin{proof}
\[\ba
...
&=\frac{i(0)s-\frac{v_C(0)}{L}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)\qty(s+\omega_0\zeta)-i(0)\omega_0\zeta-\frac{2v_C(0)\omega_0\zeta}{R}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_R&=\frac{i(0)RLCs-v_C(0)RC}{LCs^2+RCs+1}\\
&=\frac{i(0)Rs-\frac{v_C(0)R}{L}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)R\qty(s+\omega_0\zeta)-i(0)R\omega_0\zeta-2v_C(0)\omega_0\zeta}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_L&=LsI-Li(0)\\
...
&=-\frac{\qty(i(0)R+v_C(0))s+\frac{i(0)}{C}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}\\
&=-\frac{\qty(i(0)R+v_C(0))\qty(s+\omega_0\zeta)-\qty(i(0)R+v_C(0))\omega_0\zeta+\frac{i(0)R\omega_0}{2\zeta}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
\[\ba
V_C&=\frac{I}{Cs}+\frac{v_C(0)}{s}\\
&=\frac{i(0)L-\frac{v_C(0)}{s}+LCsv_C(0)+RCv_C(0)+\frac{v_C(0)}{s}}{LCs^2+RCs+1}\\
&=\frac{LCsv_C(0)+i(0)L+RCv_C(0)}{LCs^2+RCs+1}\\
&=\frac{sv_C(0)+\frac{i(0)}{C}+\frac{R}{L}v_C(0)}{s^2+2\alpha s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)s-\frac{v_C(0)}{L}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)\qty(s+\omega_0\zeta)-i(0)\omega_0\zeta-\frac{2v_C(0)\omega_0\zeta}{R}}{\qty(s+\omega_0\zeta)^2+\omega_0^{\pht{0}2}\qty(1-\zeta^2)}
\ea\]
Check consistency:
...
&=\frac{-\qty(i(0)R\qty(\zeta-\sqrt{\zeta^2-1})+2v_C(0)\zeta)\qty(s+\omega_0\qty(\zeta-\sqrt{\zeta^2-1}))+\qty(i(0)R\qty(\zeta+\sqrt{\zeta^2-1})+2v_C(0)\zeta)\qty(s+\omega_0\qty(\zeta+\sqrt{\zeta^2-1}))}{2R\sqrt{\zeta^2-1}\qty(s^2+2s\omega_0\zeta+\omega_0^{\pht{0}2})}\\
&=\frac{
-\qty(i(0)R\qty(\zeta-\sqrt{\zeta^2-1})+2v_C(0)\zeta)\qty(s+\omega_0\qty(\zeta-\sqrt{\zeta^2-1}))+\qty(i(0)R\qty(\zeta+\sqrt{\zeta^2-1})+2v_C(0)\zeta)\qty(s+\omega_0\qty(\zeta+\sqrt{\zeta^2-1}))
}
{2R\sqrt{\zeta^2-1}\qty(s^2+2s\omega_0\zeta+\omega_0^{\pht{0}2})}\\
