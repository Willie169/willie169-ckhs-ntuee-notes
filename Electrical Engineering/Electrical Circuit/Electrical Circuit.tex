...
\[i(t)=C\dv{v(t)}{t}.\]
\[I(s)=CsV(s)-Cv(0^-).\]
When analyzing natural response, a capacitor with capacitance $C$ can be treated as a capacitance $C$ without initial energy in parallel connection with an independent current source enforcing current $Cv(0^-)$. When analyzing forced response, a capacitor with capacitance $C$ can be treated as a capacitance $C$ without initial energy.
...
\[v(t)=L\dv{i(t)}{t}.\]
\[V(s)=LsI(s)-Li(0^-).\]
When analyzing natural response, an inductor with inductance $L$ can be treated as a inductance $L$ without initial energy in series connection with an independent voltage source enforcing voltage $Li(0^-)$. When analyzing forced response, an inductor with inductance $L$ can be treated as a inductance $L$ without initial energy.
...
Oriented in $R$ to $L$ to $v_{in}$ to $R$ direction:
...
\[i=Ae^{-\frac{R}{L}t}\]
\[i=i(0^-)e^{-\frac{R}{L}t}\]
\[p_R=R(i(0^-))^2e^{-\frac{2R}{L}t}\]
\[p_L=Li(0^-)e^{-\frac{R}{L}t}\qty(-\frac{R}{L})i(0^-)e^{-\frac{R}{L}t}=-R(i(0^-))^2e^{-\frac{2R}{L}t}\]
\[\ba
...
Oriented in $R$ to $C$ to $v_{in}$ to $R$ direction.
...
\[p_R=\frac{1}{R}(v_C(0^-))^2e^{-\frac{2}{RC}t}\\]
\[p_C=Cv_C(0^-)e^{-\frac{1}{RC}t}\qty(-\frac{1}{RC})v_C(0^-)e^{-\frac{1}{RC}t}=-\frac{1}{R}(v_C(0^-))^2e^{-\frac{2}{RC}t}\]
\[\ba
