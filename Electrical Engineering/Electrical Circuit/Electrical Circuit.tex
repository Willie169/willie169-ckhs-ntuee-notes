...
\[\mathca{L}\{h_L\}=1-\frac{R}{R+Ls}=\frac{Ls}{R+Ls}\]
\end{proof}
...
\begin{proof}
\[\lim_{\omega\to 0}\abs{H_{V_R}(j\omega)}=\lim_{\omega\to 0}\abs{\frac{Lj\omega}{R+Lj\omega}}=p\]
\[\lim_{\omega\to\infty}\abs{H_{V_R}(j\omega)}=\lim_{\omega\to\infty}\abs{\frac{Lj\omega}{R+Lj\omega}}=1\]
\end{proof}
\sssc{RC circuit}
...
\[\tau_{v_C}=\tau_{v_R}=\frac{1}{RC}\]
\[i=-\frac{1}{R}v_C(0^-)e^{-\frac{1}{RC}t}\]
\[p_R=-p_C=\frac{1}{R}(v_C(0^-))^2e^{-\frac{2}{RC}t}\]
\[\int_0^{\infty}p_R\dd{t}=-\int_0^{\infty}p_L\dd{t}=\frac{1}{2}C(v_C(0^-))^2\]
\[\frac{V_C}{R}+C(sV_C-V_C(0^-))=0\]
...
\ea\]
\[\frac{V_C}{R}+C(sV_C-V_C(0^-))=0\]
\[\qty(\frac{1}{R}+Cs)V_C-CV_C(0^-)=0\]
\[V_C=\frac{CV_C(0^-)}{\frac{1}{R}+Cs}=\frac{RCV_C(0^-)}{1+RCs}\]
\[I=-\frac{CV_C(0^-)}{1+RCs}\]
Check consistency:
...
\[v_C=-v_R=\frac{1}{RC}\int_0^te^{\frac{1}{RC}\tau}v_{in}(\tau)\dd{\tau}e^{-\frac{1}{RC}t}\]
\[V_C=-V_R=\frac{V_{in}}{1+RCs}\]
\[I=-\frac{V_{in}}{R(1+RCs)}\]
\begin{proof}
\[v_R+v_C=v_{in}\]
\[\frac{v_R}{R}-C\dv{v_C}{t}=0\]
\[\frac{v_C-v_{in}}{R}+C\dv{v_C}{t}=0\]
