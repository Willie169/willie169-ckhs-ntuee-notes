...
A parallel LC (resonant, tank, or tuned) circuit consists of an inductor with inductance $L$, a capacitor with capacitance $C$, and an independent current source $i_{in}$ in parallel connection. Resonance angular frequency $\omega_0$.
...
\end{proof}
Forced response:
\[\dv[2]{v}{t}+\frac{v}{LC}=\frac{1}{LC}\dv{i_{in}}{t}\]
\[\ba
