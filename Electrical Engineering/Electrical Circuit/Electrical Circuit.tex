...
&=2\frac{\omega_0\zeta}{R\sqrt{1-\zeta^2}}\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(
\sqrt{1-\zeta^2}\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))-\zeta\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))
)v_{in}(\tau)\dd{\tau}\\
