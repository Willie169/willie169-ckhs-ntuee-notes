...
\sssc{Series connection}
For linear networks, the impedance of the network is equal to the sum of the impedances of each element.
\sssc{Parallel connection}
For linear networks, the admittance of the network is equal to the sum of the admittances of each element.
