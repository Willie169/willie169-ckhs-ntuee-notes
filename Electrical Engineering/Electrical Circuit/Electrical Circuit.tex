...
PLACEHOLDER inconsistent
\item $0<\zeta<1$ Underdamped response:
\[i=2\frac{\omega_0}{R}\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\]
\[v_R=2\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\]
\[v_L=v_{in}-\frac{\omega_0}{\sqrt{1-\zeta^2}}\int_0^te^{-\omega_0\zeta(t-\tau)}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))v_{in}{\tau}\dd{\tau}\]
\[v_C=-\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{2\zeta^2-1}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+2\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\]
\begin{proof}
...
&=2\frac{\omega_0\zeta}{R\sqrt{1-\zeta^2}}\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\zeta\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\sqrt{1-\zeta^2}\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\\
&=2\frac{\omega_0}{R}\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}
\ea\]
\[v_R=2\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\]
\[\ba
v_L&=L\dv{i}{t}\\
&=2\frac{L\omega_0}{R}\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\\
&=v_{in}+\frac{1}{\zeta}\int_0^t\pdv{}{t}\qty(e^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))))v_{in}{\tau}\dd{\tau}\\
&=v_{in}+\omega_0\int_0^t\qty(-\zeta e^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))+\sqrt{1-\zeta^2}e^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta}{\sqrt{1-\zeta^2}}\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))-\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))))v_{in}{\tau}\dd{\tau}\\
&=v_{in}+\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(-\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))-\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))-\sqrt{1-\zeta^2}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\\
&=v_{in}-\frac{\omega_0}{\sqrt{1-\zeta^2}}\int_0^te^{-\omega_0\zeta(t-\tau)}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))v_{in}{\tau}\dd{\tau}
\ea\]
\[\ba
v_C&=v_{in}-v_R-v_L\\
&=-2\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}+\frac{\omega_0}{\sqrt{1-\zeta^2}}\int_0^te^{-\omega_0\zeta(t-\tau)}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))v_{in}{\tau}\dd{\tau}\\
&=\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(-\frac{2\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))-2\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+\frac{1}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}\\
&=-\omega_0\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{2\zeta^2-1}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+2\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}
\ea\]
Check $i=C\dv{v_C}{t}$:
\[\ba
C\dv{v_C}{t}&=
-2\frac{\zeta}{R}
\int_0^te^{-\omega_0\zeta(t-\tau)}\qty(\frac{2\zeta^2-1}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau))+2\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}(t-\tau)))v_{in}{\tau}\dd{\tau}
...
\[\omega_0=\frac{1}{\sqrt{LC}}\]
\[\zeta=\frac{R}{2}\sqrt{\frac{C}{L}}\]
1/L=2\frac{\omega_0\zeta}{R}
L=\frac{1}{2}\frac{R}{\omega_0\zeta}
1/C=\frac{1}{2}\frac{R\omega_0}{\zeta}
C=2\frac{\zeta}{R\omega_0}
\end{proof}
