...
An alternating current is a current whose voltage and current change over time and are zero in average over an infinite time interval.
...
Laplace domain:
\[I(s)=CsV(s)-Cv(0^-).\]
When analyzing natural response, a capacitor with capacitance $C$ can be treated as a capacitance $C$ without initial energy in series connection with an independent voltage source enforcing voltage $-v(0^-)\delta(t)$ or a capacitance $C$ without initial energy in parallel connection with an independent current source enforcing current $-Cv(0^-)\delta(t)$. When analyzing forced response, a capacitor with capacitance $C$ can be treated as a capacitance $C$ without initial energy.
...
Laplace domain:
\[V(s)=LsI(s)-Li(0^-).\]
When analyzing natural response, an inductor with inductance $L$ can be treated as a inductance $L$ without initial energy in parallel connection with an independent current source enforcing current $-i(0^-)\delta(t)$ or a inductance $L$ without initial energy in series connection with an independent voltage source enforcing voltage $-Li(0^-)\delta(t)$. When analyzing forced response, an inductor with inductance $L$ can be treated as a inductance $L$ without initial energy.
...
\sssc{RL circuit}
An RL circuit, RL filter, or RL network consist of a resistor with resistance $R$, an inductor with inductance $L$, and an independent voltage source $v_{in}$ in series connection.

Voltages and currents oriented in resistor to inductor to independent voltage source to resistor direction.
...
\end{proof}
\sssc{RC circuit}
An RC circuit, RC filter, or RC network consist of a resistor with resistance $R$, a capacitor with capacitance $C$, and an independent voltage source $v_{in}$ in series connection.

Voltages and currents oriented in resistor to capacitor to independent voltage source to resistor direction.
...
&=\frac{1}{2}C(v_C(0^-))^2
\ea\]
\[V_C=\frac{1}{\frac{1}{R}+Cs}CV_C(0^-)=\frac{RCV_C(0^-)}{1+RCs}\]
Check consistency:
...
A series LC circuit, resonant circuit, tank circuit, or tuned circuit consist of an inductor with inductance $L$, a capacitor with capacitance $C$, and an independent voltage source $v_{in}$ in series connection.

Voltages and currents oriented in inductor to capacitor to independent voltage source to inductor direction. Resonance angular frequency $\omega_0$. Total energy stored in inductor and capacitor $E$.

Natural response:
\[L\dv{i}{t}+\frac{1}{C}\int_0^ti\dd{\tau}+v_C(0^-)=0\]
\[\omega_0=\frac{1}{\sqrt{LC}}\]
\[\ba
i&=i(0^-)\cos\qty(\frac{1}{\sqrt{LC}}t)-v_C(0^-)\sqrt{\frac{C}{L}}\sin\qty(\frac{1}{\sqrt{LC}}t)\\
&=i(0^-)\cos\qty(\omega_0t)-v_C(0^-)\frac{1}{L\omega_0}\sin\qty(\omega_0t)
\ea\]
\[\ba
v_C&=-v_L\\
&=i(0^-)\frac{1}{\sqrt{LC}}\sin\qty(\frac{1}{\sqrt{LC}}t)+v_C(0^-)\frac{1}{L}\cos\qty(\frac{1}{\sqrt{LC}}t)\\
&=i(0^-)\omega_0\sin\qty(\omega_0t)+v_C(0^-)\frac{1}{L}\cos\qty(\omega_0t)
\ea\]
\[\ba
p_C&=-p_L\\
&=\frac{1}{2}\qty((i(0^-))^2+(v_C(0^-))^2\frac{C}{L})\frac{1}{\sqrt{LC}}\sin\qty(\frac{2}{\sqrt{LC}}t)-i(0^-)v_C(0^-)\frac{1}{L}\cos\qty(\frac{2}{\sqrt{LC}}t))\\
&=\frac{1}{2}\qty((i(0^-))^2+(v_C(0^-))^2\frac{C}{L})\omega_0\sin\qty(2\omega_0t)-i(0^-)v_C(0^-)\frac{1}{L}\cos\qty(2\omega_0t))
\ea\]
\[E=\frac{1}{2}\qty(C(v_C(0^-))^2+L(I(0^-))^2)\]
\[I=\frac{-Csv_C(0^-)+LCsi(0^-)}{LCs^2+1}\]
\[V_C=-V_L=\frac{LCs^2v_C(0^-)+i(0^-)}{LCs^2+1}\]
\begin{proof}
\[L\dv{i}{t}+\frac{1}{C}\int_0^ti\dd{\tau}+v_C(0^-)=0\]
\[L\dv[2]{i}{t}+\frac{1}{C}i=0\]
\[Lr^2+\frac{1}{C}=0\]
...
\[\ba
p_C&=-p_L\\
&=\qty(i(0^-)\cos\qty(\frac{1}{\sqrt{LC}}t)-v_C(0^-)\sqrt{\frac{C}{L}}\sin\qty(\frac{1}{\sqrt{LC}}t))\qty(i(0^-)\frac{1}{\sqrt{LC}}\sin\qty(\frac{1}{\sqrt{LC}}t)+v_C(0^-)\frac{1}{L}\cos\qty(\frac{1}{\sqrt{LC}}t))\\
&=\frac{1}{2}\qty((i(0^-))^2+(v_C(0^-))^2\frac{C}{L})\frac{1}{\sqrt{LC}}\sin\qty(\frac{2}{\sqrt{LC}}t)-i(0^-)v_C(0^-)\frac{1}{L}\cos\qty(\frac{2}{\sqrt{LC}}t))\\
&=\frac{1}{2}\qty((i(0^-))^2+(v_C(0^-))^2\frac{C}{L})\omega_0\sin\qty(2\omega_0t)-i(0^-)v_C(0^-)\frac{1}{L}\cos\qty(2\omega_0t))
\ea\]
\[\ba
I&=\frac{-v_C(0^-)+Li(0^-)}{Ls+\frac{1}{Cs}}\\
&=\frac{-Csv_C(0^-)+LCsi(0^-)}{LCs^2+1}
\ea\]
\[V_C=-V_L=-(LsI-Li(0^-))=\frac{LCs^2v_C(0^-)+i(0^-)}{LCs^2+1}\]
Check consistency:
\[\mathcal{L}\{i\}=\frac{i(0^-)s-v_C(0^-)\sqrt{\frac{C}{L}}\frac{1}{\sqrt{LC}}}{s^2+\frac{1}{LC}}=\frac{LCsi(0^-)-Csv_C(0^-)}{LCs^2+1}\]
\[\ba
\mathcal{L}\{v_C\}&=i(0^-)\frac{1}{\sqrt{LC}}\frac{\frac{1}{\sqrt{LC}}}{s^2+\frac{1}{LC}}+v_C(0^-)\frac{1}{L}\frac{s}{s^2+\frac{1}{LC}}\\
&=\frac{LCs^2v_C(0^-)+i(0^-)}{LCs^2+1}
\ea\]
\end{proof}
Forced response:
\[L\dv{i}{t}+\frac{1}{C}\int_0^ti\dd{\tau}=v_{in}\]
\[\ba
i&=\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}(t-\tau)v_{in}(\tau)\dd{\tau}\\
&=\int_0^t\cos\qty(\omega_0(t-\tau)v_{in}(\tau)\dd{\tau}
\ea\]
\[\ba
v_L&=v_{in}-v_C\\
&=Lv_{in}+\sqrt{\frac{L}{C}}\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}(t-\tau))v_{in}(\tau)\dd{\tau}\\
&=Lv_{in}+\sqrt{\frac{L}{C}}\int_0^t\sin\qty(\omega_0(t-\tau))v_{in}(\tau)\dd{\tau}
\ea\]
\[I=\frac{V_{in}}{Ls+\frac{1}{Cs}}=\frac{CsV_{in}}{LCs^2+1}\]
...
\begin{proof}
\[L\dv{i}{t}+\frac{1}{C}\int_0^ti\dd{\tau}=v_{in}\]
\[L\dv[2]{i}{t}+\frac{1}{C}i=\dv{v_{in}}{t}\]
\[i_1=\cos\qty(\frac{1}{\sqrt{LC}}t)\]
\[i_2=\sin\qty(\frac{1}{\sqrt{LC}}t)\]
\[\frac{1}{i_1i_2'-i_2i_1'}=\sqrt{LC}\]
\[i=-\sqrt{LC}\cos\qty(\frac{1}{\sqrt{LC}}t)\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}\tau)\dv{v_{in}}{\tau}\dd{\tau}+\sqrt{LC}\sin\qty(\frac{1}{\sqrt{LC}}t)\int\cos\qty(\frac{1}{\sqrt{LC}}\tau)\dv{v_{in}}{\tau}\dd{\tau}\]
\[\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}\tau)\dv{v_{in}}{\tau}\dd{\tau}=\sin\qty(\frac{1}{\sqrt{LC}}t)v_{in}-\frac{1}{\sqrt{LC}}\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{t}\]
\[\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}\tau)\dv{v_{in}{\tau}\dd{\tau}=\cos\qty(\frac{1}{\sqrt{LC}}t)v_{in}+\frac{1}{\sqrt{LC}}\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{\tau}\]
\[\ba
i&=-\sqrt{LC}\cos\qty(\frac{1}{\sqrt{LC}}t)\sin\qty(\frac{1}{\sqrt{LC}}t)v_{in}+\cos\qty(\frac{1}{\sqrt{LC}}t)\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{\tau}+\sqrt{LC}\sin\qty(\frac{1}{\sqrt{LC}}t)\cos\qty(\frac{1}{\sqrt{LC}}t)v_{in}+\sin\qty(\frac{1}{\sqrt{LC}}t)\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{\tau}\\
&=\cos\qty(\frac{1}{\sqrt{LC}}t)\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{\tau}+\sin\qty(\frac{1}{\sqrt{LC}}t)\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}\tau)v_{in}(\tau)\dd{\tau}\\
&=\int_0^t\qty(\cos\qty(\frac{1}{\sqrt{LC}}t)\cos\qty(\frac{1}{\sqrt{LC}}\tau)+\sin\qty(\frac{1}{\sqrt{LC}}t)\sin\qty(\frac{1}{\sqrt{LC}}\tau))v_{in}(\tau)\dd{\tau}\\
&=\int_0^t\cos\qty(\frac{1}{\sqrt{LC}}(t-\tau))v_{in}(\tau)\dd{\tau}\\
&=\int_0^t\cos\qty(\omega_0(t-\tau)v_{in}(\tau)\dd{\tau}
\ea\]
\[\ba
v_L&=v_{in}-v_C=L\dv{i}{t}\\
&=L\qty(\cos(0)v_{in}+\int_0^t\pdv{}{t}\qty(\cos\qty(\frac{1}{\sqrt{LC}}(t-\tau))v_{in}(\tau))\dd{\tau})\\
&=Lv_{in}+\sqrt{\frac{L}{C}}\int_0^t\sin\qty(\frac{1}{\sqrt{LC}}(t-\tau))v_{in}(\tau)\dd{\tau}\\
&=Lv_{in}+\sqrt{\frac{L}{C}}\int_0^t\sin\qty(\omega_0(t-\tau))v_{in}(\tau)\dd{\tau}
\ea\]
\[I=\frac{V_{in}}{Ls+\frac{1}{Cs}}=\frac{CsV_{in}}{LCs^2+1}\]
...
\[V_C=\frac{V_{in}}{LCs^2+1}\]
Check consistency:
\[\mathcal{L}\{i\}=\frac{s}{s^2+\frac{1}{LC}}V_{in}=\frac{LCsV_{in}}{LCs^2+1}\]
INCONSISTENT
