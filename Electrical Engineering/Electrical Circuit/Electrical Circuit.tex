...
Natural response (Laplace domain):
\[\ba
I&=\frac{LCsi(0)-Cv_C(0)}{LCs^2+RCs+1}\\
&=\frac{si(0)-\frac{v_C(0)}{L}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}
\ea\]
\begin{proof}
\[\ba
I&=\frac{Li(0)-\frac{v_C(0)}{s}}{Ls+R+\frac{1}{Cs}}\\
&=\frac{LCsi(0)-Cv_C(0)}{LCs^2+RCs+1}\\
&=\frac{si(0)-\frac{v_C(0)}{L}}{s^2+\frac{R}{L}s+\frac{1}{LC}}\\
&=\frac{si(0)-\frac{v_C(0)}{L}}{s^2+2\alpha s+\omega_0^{\pht{0}2}}
\ea\]
\end{proof}
\bit
