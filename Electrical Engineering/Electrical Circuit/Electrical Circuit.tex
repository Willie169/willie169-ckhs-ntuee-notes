...
\[i_C=-e^{-\omega_0\zeta t}\qty(\qty(\frac{v(0)}{R}+i_L(0))\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(\frac{v(0)}{R}\frac{1-2\zeta^2}{\zeta\sqrt{1-\zeta^2}}-i_L(0)\frac{\zeta}{\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\begin{proof}
...
\item $0<\zeta<1$ Underdamped response:
PLACEHOLDER 下待
V=\frac{v(0)s-2i_L(0)R\omega_0\zeta}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}
I_L=\frac{i_L(0)s+\frac{v(0)\omega_0}{2R\zeta}+2i_L(0)\omega_0\zeta}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}
I_C=-\frac{\qty(\frac{v(0)}{R}+i_L(0))s+\frac{v(0)\omega_0}{2R\zeta}}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}
\[v=e^{-\omega_0\zeta t}\qty(v(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\qty(v(0)+2i_L(0)R)\frac{\zeta}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[i_L=e^{-\omega_0\zeta t}\qty(i_L(0)\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(\frac{1}{2}\frac{v(0)}{R\zeta\sqrt{1-\zeta^2}}+i_L(0)\frac{\zeta}{\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[i_C=-e^{-\omega_0\zeta t}\qty(\qty(\frac{v(0)}{R}+i_L(0))\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\qty(\frac{v(0)}{R}\frac{1-2\zeta^2}{\zeta\sqrt{1-\zeta^2}}-i_L(0)\frac{\zeta}{\sqrt{1-\zeta^2}})\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\eit
