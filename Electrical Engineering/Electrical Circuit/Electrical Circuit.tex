...
\bit
\item $\zeta>1$ Overdamped response:
\[i=2\frac{\omega_0\zeta}{R}e^{-\omega_0\zeta t}\qty(\cosh(\omega_0\sqrt{\zeta^2-1}t)-\frac{\zeta}{\sqrt{\zeta^2-1}}\sinh(\omega_0\sqrt{\zeta^2-1}t))\]
\[v_R=2\omega_0\zeta e^{-\omega_0\zeta t}\qty(\cosh(\omega_0\sqrt{\zeta^2-1}t)-\frac{\zeta}{\sqrt{\zeta^2-1}}\sinh(\omega_0\sqrt{\zeta^2-1}t))\]
\[v_L=v_{in}+\omega_0e^{-\omega_0\zeta t}\qty(-2\zeta\cosh(\omega_0\sqrt{\zeta^2-1}t)+\frac{2\zeta^2-1}{\sqrt{\zeta^2-1}}\sinh(\omega_0\sqrt{\zeta^2-1}t))\]
\[v_C=\frac{\omega_0}{\sqrt{\zeta^2-1}}e^{-\omega_0\zeta t}\sinh(\omega_0\sqrt{\zeta^2-1}t)\]
\item $\zeta=1$ Critically damped response:
\[i=2\frac{\omega_0}{R}(1-\omega_0t)e^{-\omega_0t}\]
\[v_R=2\omega_0(1-\omega_0t)e^{-\omega_0t}\]
\[v_L=v_{in}-\omega_0(2-\omega_0t)e^{-\omega_0t}\]
\[v_C=\omega_0^{\pht{0}2}te^{-\omega_0t}\]
\item $0<\zeta<1$ Underdamped response:
\[i=2\frac{\omega_0}{R}e^{-\omega_0\zeta t}\qty(\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[v_R=2\omega_0e^{-\omega_0\zeta t}\qty(\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}t)-\frac{\zeta^2}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[v_L=v_{in}+\omega_0e^{-\omega_0\zeta t}\qty(-2\zeta\cos\qty(\omega_0\sqrt{1-\zeta^2}t)+\frac{2\zeta^2-1}{\sqrt{1-\zeta^2}}\sin\qty(\omega_0\sqrt{1-\zeta^2}t))\]
\[v_C=\frac{\omega_0}{\sqrt{1-\zeta^2}}e^{-\omega_0\zeta t}\sin\qty(\omega_0\sqrt{1-\zeta^2}t)\]
\end{proof}
\eit
Transfer function:
\[\ba
...
\zeta=\frac{1}{2R}\sqrt{\frac{L}{C}}
1/C=2R\omega_0\zeta
C=\frac{1}{2R\omega_0\zeta}
1/L=\frac{\omega_0}{2R\zeta}
L=\frac{2R\zeta}{\omega_0}
