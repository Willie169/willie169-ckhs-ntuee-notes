...
&=-\frac{\qty(i(0)R+v_C(0))s+\frac{i(0)R\omega_0}{2\zeta}}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}
\ea\]
\[\ba
...
&=\frac{sv_C(0)+\frac{i(0)}{C}+\frac{R}{L}v_C(0)}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)s-\frac{v_C(0)}{L}}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}\\
&=\frac{i(0)s-\frac{2v_C(0)\omega_0\zeta}{R}}{s^2+2\omega_0\zeta s+\omega_0^{\pht{0}2}}
\ea\]
Check consistency:
\bit
