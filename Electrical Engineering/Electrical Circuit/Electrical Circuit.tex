...
\ea\]
\[\ba
i&=\frac{1}{L\omega_0\sqrt{1-\zeta^2}}\qty(-e^{-\omega_0\zeta t}\cos\qty(\omega_0\sqrt{1-\zeta^2}t)\int_0^te^{\omega_0\zeta\tau}\sin\qty(\omega_0\sqrt{1-\zeta^2}\tau)\dv{v_{in}}{\tau}\dd{\tau}+e^{-\omega_0\zeta t}\sin\qty(\omega_0\sqrt{1-\zeta^2}t)\int_0^te^{\omega_0\zeta\tau}\cos\qty(\omega_0\sqrt{1-\zeta^2}\tau)\dv{v_{in}}{\tau}\dd{\tau})\\
...
\epr
\item $\zeta=1$ Critically damped response:
\[v=2R\omega_0\int(1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]
\[i_R=2\omega_0\int(1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]
\[i_C=i_{in}-\omega_0\int\qty(2-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]
\[i_L=\omega_0^{\pht{0}2}\int(t-\tau)e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]

\omega_0=\frac{1}{\sqrt{LC}}
=\frac{1}{2R}\sqrt{\frac{L}{C}}
1/C=2R\omega_0
C=\frac{1}{2R\omega_0}
1/L=\frac{\omega_0}{2R}
L=\frac{2R}{\omega_0}
...
\[\ba
v&=2R\omega_0\qty(-e^{-\omega_0t}\int te^{\omega_0\tau}\dv{i_{in}}{\tau}\dd{\tau}+te^{-\omega_0t}\int e^{\omega_0\tau}\dv{i_{in}}{\tau}\dd{\tau})\\
&=2R\omega_0\qty(-e^{-\omega_0t}\qty(te^{\omega_0t}(i_{in}-i_{in}(0))-\int(1+\omega_0\tau)e^{\omega_0\tau}i_{in}(\tau)\dd{\tau})+te^{-\omega_0t}\qty(e^{\omega_0t}(i_{in}-i_{in}(0))-\int\omega_0e^{\omega_0\tau}i_{in}(\tau)\dd{\tau}))\\
&=2R\omega_0\int(1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}
\ea\]
\[i_R=2\omega_0\int(1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]
\[\ba
i_C&=C\dv{v}{t}\\
&=i_{in}+\int\pdv{}{t}\qty((1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)})i_{in}(\tau)\dd{\tau}\\
&=i_{in}-\omega_0\int\qty(2-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}
\ea\]
\[\ba
i_L&=i_{in}-i_R-i_C\\
&=\omega_0^{\pht{0}2}\int(t-\tau)e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}
\ea\]
Check $v=L\dv{i_L}{t}$:
\[L\dv{i_L}{t}=2R\omega_0\int(1-\omega_0(t-\tau))e^{-\omega_0(t-\tau)}i_{in}(\tau)\dd{\tau}\]
\epr
\item $0<\zeta<1$ Underdamped response:
