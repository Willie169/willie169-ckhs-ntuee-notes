...
A series LC (resonant, tank, or tuned) circuit consists of an inductor with inductance $L$, a capacitor with capacitance $C$, and an independent voltage source $v_{in}$ in series connection. Resonance angular frequency $\omega_0$.
