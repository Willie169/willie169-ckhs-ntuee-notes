...
\[\ba
i&=\frac{1}{L}\qty(-e^{-\omega_0t}\int_0^t\tau e^{\omega_0\tau}\dv{v_{in}}{\tau}\dd{\tau}+te^{-\omega_0t}\int_0^te^{\omega_0\tau}\dv{v_{in}}{\tau}\dd{\tau})\\
...
&=\frac{R\zeta}{\sqrt{\zeta^2-1}}\qty(e^{-\omega_0\qty(\zeta-\sqrt{\zeta^2-1})t}\qty(e^{\omega_0\qty(\zeta-\sqrt{\zeta^2-1})t}(i_{in}-v(0))-\omega_0\qty(\zeta-\sqrt{\zeta^2-1})\int_0^te^{\omega_0\qty(\zeta-\sqrt{\zeta^2-1})\tau}i_{in}(\tau)\dd{\tau})-e^{-\omega_0\qty(\zeta-\sqrt{\zeta^2-1})t}\qty(e^{\omega_0\qty(\zeta+\sqrt{\zeta^2-1})t}(i_{in}-v(0))-\omega_0\qty(\zeta+\sqrt{\zeta^2-1})\int_0^te^{\omega_0\qty(\zeta+\sqrt{\zeta^2-1})\tau}i_{in}(\tau)\dd{\tau}))\\
