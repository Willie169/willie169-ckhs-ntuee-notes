...
The resistance $R$ of an element is the voltage across it over the current through it:
\[v=Ri.\]
...
Energy stored:
\[\int_{-\infty}^tp\dd{t}=\frac{1}{2}Cv^2.\]
...
Energy stored:
\[\int_{-\infty}^tp\dd{t}=\frac{1}{2}Li^2.\]
\sssc{Reactance}
...
When the context is clear, sinusoidal AC may be called AC.
...
\sssc{Current}
Here, all currents discussed are linear combinations of sinusoidal AC and DC components, and by the superposition principle, can be analyzed by analyzing each sinusoidal AC and DC component separately and summing the voltages and currents.
\sssc{Series connection}
For linear networks, the impedance of the network is equal to the sum of the impedance of each element, the reciprocal of the capacitance of the network is equal to the sum of the reciprocal of the capacitance of each element, and the inductance of the network is equal to the sum of the inductance of each element.
\sssc{Parallel connection}
For linear networks, the admittance of the network is equal to the sum of the admittance of each element, the capacitance of the network is equal to the sum of the capacitance of each element, and the reciprocal of the inductance of the network is equal to the sum of the reciprocal of the inductance of each element.
