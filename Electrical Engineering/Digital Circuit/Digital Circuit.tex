...
\item Use a LUT with a number of leading bits of $D$ and a number of leading bits of $R$ as inputs to determine an integer $q_i\in[-2^{k-1},2^{k-1}]$ such that $\abs(R+q_iD)\le D$.
