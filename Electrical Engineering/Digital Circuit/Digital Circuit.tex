...
Three $n$-bit registers, remainder register $R$, quotient register $Q$ initially holding dividend $N$, and divisor register $D$, and one subtractor are used. Treat ${R,Q}$ as one combined register. In each iteration,
\ben
\item Shift ${R,Q}$ left by one.
...
Three $n$-bit registers, remainder register $R$, quotient register $Q$ initially holding dividend $N$, and divisor register $D$, and one subtractor are used. Treat ${R,Q}$ as one combined register. A flag bit $F$ exists and initially set to 0. In each iteration,
\ben
\item Shift ${R,Q}$ left by one.
\item Check $F$.
\bit
...
\eit
\een
Iterate $n$ times. And then check $F$.
\bit
