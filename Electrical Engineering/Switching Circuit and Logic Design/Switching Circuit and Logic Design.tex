...
\sssc{Latches}
Latches are level-triggered data storage elements that store a single bit of data; one of its two states represents a "one" and the other represents a "zero". "Level-triggered" means it responds to the level change of input signals.
\sssc{Flip-flops}
