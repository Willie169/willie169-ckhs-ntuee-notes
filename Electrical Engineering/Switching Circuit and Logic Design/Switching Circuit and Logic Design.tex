...
A state-transition table, transition table, or next-state table of a sequential circuit is a truth table with output variables replaced with next-state variables (labeled with superscript $^+$) and sometimes also output variables and input variables replaced with present-state variables and sometimes also input variables.
\sssc{Next-state Map}
