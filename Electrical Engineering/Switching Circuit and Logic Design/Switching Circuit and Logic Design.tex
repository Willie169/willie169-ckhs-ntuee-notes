...
A state-transition table or transition table of a sequential circuit is a truth table with output replaced with next state, and input replaced with present state and for Mealy circuit also output, where the states can be presented with the combination of the real Boolean values of the latches or symbols such as $S_0,S_1,\ldots$.
\sssc{Next-state Map}
