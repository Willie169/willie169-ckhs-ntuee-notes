...
\sssc{State Transition Graph or Transition Graph}
The graph of states of a sychronous circuit with directed edges indicating the transition to next state for all states is called (state) transition graph.
