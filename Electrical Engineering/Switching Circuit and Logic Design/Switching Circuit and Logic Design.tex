...
\sss{Gated latch}
A gated latch is a latch with an extra input signal called enable (EN) or clock (clk) that controls whether the latch is transparent (enabled) or hold (disabled). When EN is at active level (1 for active-high latch and 0 for active-low latch), the latch is transparent, meaning the output follows the input; when EN is at inactive level (0 for active-high latch and 1 for active-low latch), the latch is hold, meaning the output remains at its previous state regardless of input changes.
\sssc{Flip-flops}
...
By making $SR=0$ don't care combination, we can simplify it as:
\[Q^+=SE+Q(R'+E').\]
\[P=(SE+(SE+Q(R'+E')))'=(SE)'(SE+Q(R'+E'))'=(S'+E')(SE)'(Q(R'+E'))'=(S'+E')(Q'+RE)=S'Q+S'RE+E'Q'=RE+Q'(S'+E').\]
\[Q^+'=(SE+Q(R'+E'))'=(SE)'(Q(R'+E'))'=(S'+E')(Q'+RE)=S'Q'+S'RE+E'Q.\]
By making $SR=0$ don't care combination, we can simplify it as:
\[Q^+'=RE+Q'(S+E')=P.\]
If we plot the next-state equation for $Q^+$ on a K-map:
