...
\hline
Q_k & Q_^+_k & S_k & R_k \\\hline
0 & 0 & 0 & X \\\hline
0 & 1 & 1 & 0 \\\hline
1 & 0 & 0 & 1 \\\hline
1 & 1 & X & 0 \\\hline
\end{longtable}
These maps are called S input (K-)maps and R input (K-)maps. S input maps are the same as the next-state maps with 1's in $Q_k=1$ half replaced with X. S input maps are the same as the next-state maps with 0's in $Q_k=0$ half replaced with X.
