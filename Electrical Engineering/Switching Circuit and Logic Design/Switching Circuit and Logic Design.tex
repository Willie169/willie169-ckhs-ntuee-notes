...
\sssc{State diagram}
Same as Moore and Mealy machines, state diagrams are commonly used to analyze Moore and Mealy circuits, with the states typically represented by meaningless symbol and starting state often not shown.
\sssc{Next-state Map}
