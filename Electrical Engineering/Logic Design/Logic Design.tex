...
\sssc{Flip-flop input map}
Given a next-state map of a flip-flop, to find the input needed for each present state variables and input variables combination, convert the value $Q^+_k$ in it to the input given by the transition function of the flip-flop for every 0 and 1 cell to get flip-flop input maps.
\sssc{T input map}
