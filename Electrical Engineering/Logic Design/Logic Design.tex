...
\sssc{(Edge-triggered) S-R flip-flop (SRFF)}
...
A master-slave S-R flip-flop consist of two gated S-R latches in which, with the inputs and outputs of the master be with subscript $_1$ and those of the slave be with subscript $_2$, $Q_1$ and $Q_1'$ are connected to $S_2$ and $R_2$ respectively, and $Q_2$ and $Q_2'$ are the final outputs of it.
\sssc{Master-slave D flip-flop}
A master-slave D flip-flop consist of two gated D latch in which, with the inputs and outputs of the master be with subscript $_1$ and those of the slave be with subscript $_2$, $Q_1$ is connected to $D_2$, $Q_1'$ is discarded, and $Q_2$ and $Q_2'$ are the final outputs of it.
\sssc{Master-slave J-K flip-flop}
A master-slave J-K flip-flop consist of a master gated J-K latch and a slave gated S-R latches in which, with the inputs and outputs of the master be with subscript $_1$ and those of the slave be with subscript $_2$, $Q_1$ and $Q_1'$ are connected to $S_2$ and $R_2$ respectively, and $Q_2$ and $Q_2'$ are the final outputs of it.
...
For Mealy circuits, alternatively, we may list the next states given all input characters respectively given a present state in the same row with the scenario of each input character in one column and labeled in the header row.
