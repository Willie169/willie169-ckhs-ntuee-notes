...
Given multi-input logic gates $A_1,A_2,\ldots A_m$, circuit of $A_1,A_2,\ldots A_m$ gates implies no particular ordering of the gates.
...
\sssc{Forms and design of two-level circuits}
A degenerate form can degenerate into one-level circuit, while a non-degenerate form can't and is an implementation of a SOP form or POS form.

There are 16 forms of two-level circuit given AND, OR, NAND, NOR gates, in which the degenerate forms are
\bit
...
\eit
and the non-degenerate forms that implement POS form are
\bit
