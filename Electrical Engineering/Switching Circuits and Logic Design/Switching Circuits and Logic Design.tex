...
Maxterm expansion, canonical POS, or standard POS is an expression of a Boolean function as a product of maxterms of it, that is,
\[f=\prod_{i\in T}M_i,\]
also denoted as 
\[f=\prod M(i\in T).\]
...
\ssc{Examples of Construction of Boolean Vector Functions}
\sssc{Unsigned binary number adder}