...
\sssc{Negation}
The negation can be computed by inverting all bits, that is, subtract it from $2^N-1$.
\sssc{Addition}
...
\sssc{Negation}
The negation can be computed by inverting all bits and add $1$, that is, subtract it from $2^N$.
\begin{proof}\mbox{}\\
