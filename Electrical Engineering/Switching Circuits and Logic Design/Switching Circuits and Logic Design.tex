...
\date{\temtoday}
\titletocdoc
\sct{Switching Circuits and Logic Design}
...
For this reason, we will not normally count inverters which are connected directly Multi-Level Gate Circuits NAND and NOR Gates to input variables when determining the number of levels in a circuit
