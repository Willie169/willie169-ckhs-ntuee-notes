...
\sssc{Minimum POS form}
To find a minimum POS form of a function $f$, we can use K-map to find a minimum SOP form of $f'$, and:
\bit
\item Change all literals to its inverse.
\item Change all product term to sum term of the same literals.
\item The product of the sum terms obtained is  a minimum POS form of $f$.
\eit

Alternatively, we can find a minimum POS form of a function $f$ by K-map but group $0$s (and $X$s when appropriate) instead of $1$s.
