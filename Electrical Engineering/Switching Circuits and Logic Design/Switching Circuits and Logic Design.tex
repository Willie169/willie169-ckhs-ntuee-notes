...
\item If $f(P,E)=0=f(P,E')=0$, leave the cell empty or enter $0$.
\item If $f(P,E)=0$ and $f(P,E')=X$, leave the cell empty or enter $0$.
\item If $f(P,E)=X$ and $f(P,E')=0$, leave the cell empty or enter $0$.
\eit
