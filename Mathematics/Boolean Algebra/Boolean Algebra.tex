...
\item Remark: If $A \iff B$, then $A$ is called a sufficient necessary condition of $B$.
\eit
...
\item Remark: If $A \implies B$, then $A$ is called a sufficient condition of $B$ or stronger than $B$, and $B$ is called a necessary condition of $A$ or weaket than $A$. The contraposition, contrapositive, or transposition of $A\implies B$ is $(\neg B)\implies (\neg A)$ and is equal to $A\implies B$.
\eit
