...
PLACEHOLDER: rng and ring etc. second not R\setminus\{0\} but R, isn't it?
\sssc{Rng or non-unital ring}
A rng or non-unital ring is a ordered triple $(R,+,\cdot)$ of set $R$ and binary operations $+$ and $\cdot$ on $R$ called addition and multiplication such that
\bit
\item $(R,+)$ is an abelian group under addition with $0$ as the identity element, called addictive identity,
\item $(R\setminus\{0\},\cdot)$ is a semigroup under multiplication, and
\item Distributivity of multiplication over addition:
\[a\cdot (b+c)=(a\cdot b)+(b\cdot c).\]
\eit
\sssc{Ring}
A ring is a ordered triple $(R,+,\cdot)$ of set $R$ and binary operations $+$ and $\cdot$ on $R$ called addition and multiplication such that
\bit
\item $(R,+)$ is an abelian group under addition with $0$ as the identity element, called addictive identity,
\item $(R\setminus\{0\},\cdot)$ is a monoid under multiplication with $1$ as the identity element, called multiplicative identity, and
\item Distributivity of multiplication over addition:
\[a\cdot (b+c)=(a\cdot b)+(b\cdot c).\]
\eit
