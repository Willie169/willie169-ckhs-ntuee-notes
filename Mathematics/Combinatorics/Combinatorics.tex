...
\[(A\cup B)'=A'\cap B'.\]
\[(A\cap B)'=A'\cup B'.\]
\sssc{Counting principle for power set (冪集計數原理)}
\[\abs{2^A}=2^{\abs{A}}\]
...
\subsubsection{Real part of $m$ and real part of $n-m$ greater than $-1$}
...
\subsubsection{Real part of $n_i$ and real part of $n-k$ greater than $-1$}
