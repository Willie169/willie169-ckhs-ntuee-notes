...
\sssc{Stability}
A response is called asymptotically stable iff all poles of it are on the left half-plane, that is, it converges to an equilibrium in time domain.

A response is called unstable iff all poles of it are on the left half-plane, that is, it converges to an equilibrium in time domain.
