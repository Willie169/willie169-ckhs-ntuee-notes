...
A normalized low-pass prototype filter is a low-pass filter with cutoff frequency $\omega_c=1$. Suppose the transfer function of it is $H_P(s)$. A normalized low-pass prototype filter is usually defined with $\abs{H(i\omega)}^2=H(i\omega)H(-i\omega)$.
