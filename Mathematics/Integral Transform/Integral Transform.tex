...
\[\mathcal{L}\qty\{f*T\}=F(s)\mathcal{L}\{T\}.\]
\bpr
By Fubini's theorem,
\[\ba
\mathcal{L}\qty\{f*T\}&=\int_R\langle T(x),f(t-x)\rangle e^{-st}\dd{t}\\
...
\epr
For distributions:
\[\mathcal{L}\qty\{S*T\}=\mathcal{L}\{S\}\mathcal{L}\{T\}.\]
\bpr
By Fubini's theorem,
\[\ba
\mathcal{L}\qty\{S*T\}&=\langle S(t),\langle T(x),e^{-s(t+x)}\rangle\rangle\\
