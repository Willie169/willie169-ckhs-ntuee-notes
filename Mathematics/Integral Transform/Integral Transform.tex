...
\ea\]
\epr
PLACEHOLDER: For two-sided Laplace transform of functional and distribution:
PLACEHOLDER: For two-sided Laplace transform of distributions:
...
\sssc{Inverse Laplace transform of non-negative integer power function}
For any $c\in\bbC$ and $n\in\bbN_0$,
\[\mathcal{L}^{-1}\{cs^n\}=0\]
\bpr
