...
For functional $f$ of expertial order and $s\in\bbR$,
...
For functional $f(t)$ with finite limit at $\infty$ and its Laplace transform $F(s)$ with no pole in $\{s\in\bbC\mid \Re(s)\geq 0\}\setminus\{0\}$, for $\{s\in\bbC\mid \Re(s)\geq 0\}$,
\[\lim_{t\to\infty}f(t)=\lim_{s\to 0}sF(s).\]
For functional $f(t)$ and its Laplace transform $F(s)$ with no pole in $\{s\in\bbC\mid \Re(s)\geq 0\}\setminus\{0\}$, for $\{s\in\bbC\mid \Re(s)\geq 0\}$,
\[\abs{\lim_{t\to\infty}f(t)}=\abs{\lim_{s\to 0}sF(s)},\]
and if there is no multiple pole of $F(s)$ at $s=0$,
\[\lim_{t\to\infty}f(t)=\lim_{s\to 0}sF(s).\]
\bpr
PLACEHOLDER
\epr
