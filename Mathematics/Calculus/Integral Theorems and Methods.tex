...
Suppose $C$ is a piecewise $C^1$, oriented, simple curve with initial point $a$ and terminal point $b$. If $\mb{F}$ is a scalar or vector field differentiable on a neighborhood of $C$, then
