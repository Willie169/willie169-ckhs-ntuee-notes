...
Suppose $C\colon\mb{r}(t),\quad t\in[a,b]$ is a piecewise $C^1$, oriented, simple curve. If $\mb{F}$ is a scalar or vector field differentiable on a neighborhood of $C$, then
...
on $U$.
\bpr
If: Any piecewise $C^1$, simple, closed curve $C$ in $U$ bounds a simply-connected surface $S\subseteq U$, by Green's theorem,
...
on $U$.
\bpr
If: Any piecewise $C^1$, simple, closed curve $C$ in $U$ bounds a simply-connected surface $S\subseteq U$, by Stokes' theorem,
