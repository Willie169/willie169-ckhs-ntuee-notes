...
For a power series $S_n(x)=\sum_{n=0}^{\infty}c_n(x-a)^n$, the interval of $x$ such that $S_n(x)$ is convergent is called interval of convergence, and if $S_n(x)$ is convergent for $|x-a|<R$ and divergent for $|x-a|>R$, then $R$ is called radius of convergence.
