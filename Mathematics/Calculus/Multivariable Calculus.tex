...
\item Upward orientation: In $\bbR^2$, a surface is oriented upward unless otherwise specified.
\item Outward orientation: The boundary surface $S$ of a compact region of the same dimension of the space is oriented outward unless otherwise specified.
\end{itemize}
