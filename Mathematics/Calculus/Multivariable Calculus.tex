...
In two dimensions, $\pdv{T_2}{x_1}-\pdv{T_1}{x_2}$ is sometimes called curl too.
...
An $n$-dimensional vector field $\mb{v}$ defined on an open subset $U$ of $\bbR^n$ is said ti be conservative if there exists a $C^1$ scalar field $\varphi$ on $U$ such that
\[\mb{v}=\nabla\varphi\]
on $U$.
