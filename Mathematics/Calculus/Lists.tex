...
\end{proof}
\ssc{List of Nablas}
\sssc{Gradient of $\abs{\mb{r}}$}
\[\nabla\abs{\mb{r}}^n=n\abs{\mb{r}}^{n-2}\mb{r}\]
\bpr
\[\nabla\abs{\mb{r}}=n\abs{\mb{r}}^{n-1}\nabla\abs{\mb{r}}\]
\[\nabla\abs{\mb{r}}=\qty(\frac{x}{\abs{\mb{r}}},\frac{y}{\abs{\mb{r}}},\frac{z}{\abs{\mb{r}}})=\frac{\mb{r}}{\abs{\mb{r}}}\]
\epr
