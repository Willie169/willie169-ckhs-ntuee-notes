...
\[\ln(1+x)=\ln(1+a)+\sum_{n=1}^{\infty}\frac{(-1)^{n-1}}{n}\qty(\frac{x-a}{1+a})^n,\quad -1<x\le 1+2a.\]
\[\ln(1-x)=-\sum_{n=1}^{\infty}\frac{1}{n}x^n,\quad -1\le x<1.\]
\[\ln(1-x)=\ln(1-a)-\sum_{n=1}^{\infty}\frac{1}{n}\qty(\frac{x-a}{1-a})^n,\quad 2a-1\le x<1.\]
\subsubsection{Exponential function}
