...
\subsubsection{Logarithmic function}
\[\ln(x)=\ln(a)+\sum_{n=1}^{\infty}\frac{(-1)^{n+1}}{n}\qty(\frac{x-a}{a})^n,\quad 0\le x\le 2a\land a>0.\]
\begin{proof}
\[\dv{\ln(x)}{x}=x^{-1}.\]
...
\[\ln(1+x)=\ln(1+a)+\sum_{n=1}^{\infty}\frac{(-1)^{n+1}}{n}\qty(\frac{x-a}{1+a})^n,\quad -1<x\le 1+2a\land a>-1.\]
