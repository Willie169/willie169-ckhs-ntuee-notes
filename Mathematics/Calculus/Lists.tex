...
\end{proof}
\[\sqrt{a^2+x^2}=\sum_{n=0}^{\infty}\frac{(-1)^{n-1}(2n)!}{4^n(n!)^2(2n-1)}\frac{x^{2n}}{a^{2n-1}}.\]
\subsubsection{$(1-x)^r$}
\[(1-x)^r=\sum_{n=0}^{\infty}\binom{r}{n}(-x)^n,\quad r\in\bbN_0\lor-1<x<1\lor(-1\le x\le1\land r>0)\lor(x=-1\land-1<r<0).\]
\bpr
...
\end{proof}
\[\sqrt{a^2-x^2}=-\sum_{n=0}^{\infty}\frac{(2n)!}{4^n(n!)^2(2n-1)}\frac{x^{2n}}{a^{2n-1}}.\]
\subsubsection{Logarithmic function}
...
\[\ln(1+x)=\ln(1+a)+\sum_{n=1}^{\infty}\frac{(-1)^{n-1}}{n(1+a)^n}(x-a)^n,\quad -1<x\le 1+2a.\]
\[\ln(1-x)=-\sum_{n=1}^{\infty}\frac{1}{n}x^n,\quad -1\le x<1.\]
\[\ln(1-x)=\ln(1-a)-\sum_{n=1}^{\infty}\frac{1}{n(1-a)^n}(x-a)^n,\quad 2a-1\le x<1.\]
\subsubsection{Exponential function}
