...
$g(t)$ is called to lag $f(t)$ by phase $\tau$ or phase angle $2\pi(\Delta\Phi)$. $f(t)$ is called to lead $g(t)$ by phase $\tau$ or phase angle $2\pi(\Delta\Phi)$. The phase difference (相位差) and phase angle difference (相位角差) between them are defined as the magnitude of $\Delta\Phi$ and $\Delta\phi$ respectively.
