...
\ssc{Limit Laws}
Limits of sequences, series, nets, or functions with real domains (below referred to as functions) that are in $\mathbb{R}\cup\{-\infty,\infty\}$ follow the following law.
