...
\sssc{Types of singularities or singular points for complex functions}
PLACEHOLDER
...
\sssc{As extended real-valued function with informally assigned integral properties}
The Dirac delta function $\delta(x)\colon\bbR\to\bar{\bbR}$ is a function defined as
\[\delta(x) =
\begin{cases}
\infty, & x = 0, \\
0, & x \neq 0
\end{cases}\]
and for all $0\in\Omega\subseteq D_f\subseteq\bbR$, for all indexed family $A\colon I\to\mathcal{A}\subseteq D_f;\;i\mapsto A_i$ with $I=J\cap\bbN$ for some interval $J$,
