...
\[\int\frac{f'(x)}{f(x)}\,\mathrm{d}x=\ln|f(x)|+C,\quad f(x)\neq 0.\]
\sssc{$\frac{1}{x^2+a^2}$}
\[\int\frac{1}{x^2+a^2}\,\mathrm{d}x=\frac{1}{a}\arctan\frac{x}{a}+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{1}{x^2+a^2}\,\mathrm{d}x&=\frac{1}{a}\int\frac{1}{u^2+1^2}\dd{u},\quad u=\frac{x}{a},\quad\dd{u}=\frac{1}{a}\dd{x}\\
&=\frac{1}{a}\arctan\frac{x}{a}+C
\ea\]
\end{proof}
\sssc{$\frac{1}{x^2-a^2}$}
\[\int\frac{1}{x^2-a^2}\,\mathrm{d}x=\frac{1}{2a}\ln(\frac{x-a}{x+a})+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{1}{x^2-a^2}\,\mathrm{d}x&=\int\frac{1}{2a}\qty(\frac{1}{x-a}-\frac{1}{x+a})\dd{x}\\
&=\frac{1}{2a}\ln(\frac{x-a}{x+a})+C
\ea\]
\end{proof}
\sssc{$\frac{1}{a^2-x^2}$}
\[\int\frac{1}{a^2-x^2}\,\mathrm{d}x=\frac{1}{2a}\ln(\frac{a-x}{a+x})+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{1}{a^2-x^2}\,\mathrm{d}x&=\int\frac{1}{2a}\qty(\frac{1}{a-x}-\frac{1}{a+x})\dd{x}\\
&=\frac{1}{2a}\ln(\frac{a-x}{a+x})+C
\ea\]
\end{proof}
\sssc{$ax+b$}
\[\int\frac{1}{ax+b}\,\mathrm{d}x=\frac{1}{a}\ln|ax+b|+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{1}{ax+b}\,\mathrm{d}x&=\frac{1}{a}\int\frac{1}{u}\dd{u},\quad u=ax+b,\quad\dd{u}=a\dd{x}\\
&=\frac{1}{a}\ln|ax+b|+C
\ea\]
\end{proof}
\[\int(ax+b)^n\,\mathrm{d}x=\frac{1}{a(n+1)}(ax+b)^{n-1}+C,\quad a\neq 0\land n\neq -1.\]
\begin{proof}
\[\ba
\int(ax+b)^n\,\mathrm{d}x&=\frac{1}{a}\int u^n\dd{u},\quad u=ax+b,\quad \dd{u}=a\dd{x}\\
&=\frac{1}{a(n+1)}(ax+b)^{n-1}+C
\ea\]
\end{proof}
\[\int\frac{x}{ax+b}\,\mathrm{d}x=\frac{x}{a}-\frac{b}{a^2}\ln|ax+b|+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{x}{ax+b}\,\mathrm{d}x&=\int\frac{u-b}{a^2u}\dd{u},\quad u=ax+b,\quad \dd{u}=a\dd{x}\\
&=\frac{ax+b}{a^2}-\frac{b}{a^2}\ln|ax+b|+C\\
&=\frac{x}{a}-\frac{b}{a^2}\ln|ax+b|+C
\ea\]
\end{proof}
\[\int\frac{x}{(ax+b)^2}\,\mathrm{d}x=\frac{1}{a^2}\ln|ax+b|+\frac{b}{a^2(ax+b)}+C,\quad a\neq 0.\]
\begin{proof}
\[\ba
\int\frac{x}{(ax+b)^2}\,\mathrm{d}x&=\int\frac{u-b}{a^2u^2}\dd{u},\quad u=ax+b,\quad \dd{u}=a\dd{x}\\
&=\frac{1}{a^2}\ln|ax+b|+\frac{b}{a^2(ax+b)}
\ea\]
\end{proof}
\[\int x(ax+b)^n\,\mathrm{d}x=\frac{a(n+1)x-b}{a^2(n+1)(n+2)}(ax+b)^{n+1}+C,\quad a\neq 0\land n\notin\{-1,-2\}.\]
\begin{proof}
\[\ba
\int x(ax+b)^n\,\mathrm{d}x&=\int\frac{u-b}{a^2}u^n\dd{u},\quad u=ax+b,\quad \dd{u}=a\dd{x}\\
...
\begin{proof}
\[\ba
\int\sqrt{x^2-a^2}\,\mathrm{d}x&=a^2\int\sqrt{u^2-1}\dd{u},\quad u=\frac{x}{|a|},\quad\dd{u}=\frac{1}{|a|}\dd{x}\\
...
\sssc{$\sqrt{a^2-x^2}$}
\[\int\sqrt{a^2-x^2}\,\mathrm{d}x=\frac{x}{2}\sqrt{a^2-x^2}+\frac{a^2}{2}\arcsin\frac{x}{|a|}+C,\quad a^2\geq x^2.\]
\begin{proof}
\[\ba
\int\sqrt{a^2-x^2}\,\mathrm{d}x&=a^2\int\sqrt{1-u^2}\dd{u},\quad u=\frac{x}{|a|},\quad\dd{u}=\frac{1}{|a|}\dd{x}\\
