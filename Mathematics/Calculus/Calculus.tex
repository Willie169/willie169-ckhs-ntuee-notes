...
\epr
\ssc{Integral test}
Suppose $f(x)\colon [1,\infty)$ is bounded and monotone, and $\lim_{x\to\infty}f(x)=0$. Then, $\int_1^{\infty}f(x)\dd{x}$ is convergent iff $\sum_{n=1}^{\infty}f(n)$ is convergent, and for any $N\in\bbN$,
