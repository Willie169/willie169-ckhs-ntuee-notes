...
\sct{Examples}
\ssc{Sequence and Series}
\sssc{Arithmetic progression or sequence (等差數列) and arithmetic series (等差級數)}
...
\sssc{Geometric progression or sequence (等比 or 幾何數列) and geometric series (等比 or 幾何級數)}
