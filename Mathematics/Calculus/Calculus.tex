...
\sssc{Exponential law}
The limit of $n$ to the power of a function, in which $n$ is a positive real number, is $n$ to the power of the limit of the function.
\sssc{Logarithmic law}
The limit of the logarithm base $a$ of a positive function, in which $a\in\bbR_{>0}\setminus\{1\}$, is the logarithm base $a$ of the limit of the function.
