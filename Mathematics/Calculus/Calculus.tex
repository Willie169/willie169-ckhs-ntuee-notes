...
\[\dv{\arcsech(x)}{x}=-\frac{1}{x\sqrt{1-x^2}},\quad 0<x\leq 1.\]
\begin{proof}
\[\ba
...
\end{proof}
\sssc{$\frac{1}{x^2-a^2}$}
\[\int\frac{1}{x^2-a^2}\dd{x}=\frac{1}{2a}\ln(\frac{x-a}{x+a})+C,\quad a>0\land x^2-a^2>0.\]
\begin{proof}
\[\ba
...
\end{proof}
\sssc{$\frac{1}{a^2-x^2}$}
\[\int\frac{1}{a^2-x^2}\dd{x}=\frac{1}{2a}\ln(\frac{a-x}{a+x})+C,\quad a>0\land a^2-x^2>0.\]
\begin{proof}
\[\ba
