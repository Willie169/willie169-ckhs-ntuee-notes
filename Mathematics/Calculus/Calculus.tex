...
We say a function is from, over, or on its domain (or sometimes a superset of its domain) and into or to its codomain. We also say a function is between its domain (or sometimes a superset of its domain) and its codomain.
...
\sssc{Premise}
Riemann integral and Darboux integral are two equivalent definitions of definite integral of functions over compact intervals of $\mathbb{R}$ to $\mathbb{R}$.
...
A function on bounded a compact interval $I$ is Riemann integrable over $I$ if and only if it is continuous almost everywhere in $I$.
...
An equation containing the derivatives of one or more unknown functions or dependent variables in $\mathbb{R}^n,\quad n\in\mathbb{N}$, with respect to one or more independent variables in $\matbbb{R}$, is said to be a differential equation (DE).
