...
Let $f\colon D\subseteq\mathbb{R}\to\mathbb{R}$ be a function and $I\subseteq D$ be an interval such that $f\in C^{\infty}(I)$, then the Taylor series of $f$ at $a\in I$ (or about $a$, near $a$, or centered at $a$) is
...
Let $f\colon D\subseteq\mathbb{R}\to\mathbb{R}$ be a function and $I\subseteq D$ be an interval $f$ is $k$ times differentiable on, then the $k$-th degree (or order) Taylor polynomial (or approximation) of $f$ at $a\in I$ (or about $a$, near $a$, or centered at $a$) is
...
Let $f\colon D\subseteq\mathbb{R}^m\to\mathbb{R}$ be a function and $I\subseteq D$ be an open ball such that $f\in C^{\infty}(I)$, then the Taylor series of $f$ at $a\in I$ (or about $a$, near $a$, or centered at $a$) is
...
\sssc{Taylor polynomial}
Let $f\colon D\subseteq\mathbb{R}^m\to\mathbb{R}$ be a function and $I\subseteq D$ be an open ball $f$ is $k$ times differentiable on, then the $k$-th degree (or order) Taylor polynomial (or approximation) of $f$ at $a\in I$ (or about $a$, near $a$, or centered at $a$) is
...
The integral does not depend on the parameterization of the curve as long as the curve starts at $\gamma(a)$ and ends at $\gamma(b)$ and is piecewise $C^1$.
...
\ssc{Curve}
\sssc{Definition}
A (parameterized or parametric) (topological) curve in a topological space $X$ is a continuous map $\gamma(t)\colon I\to X$ for some interval $I$, where $t$ is called parameter and either $\gamma(t)$ or the image of $\gamma(t)$ is called curve, and $\gamma(t)$ is also called the parameterization of the curve.
...
A plane curve is a curve on a plane.

A Jordan curve is a plane simple closed curve. And the region enclosed by a Jordan curve is called Jordan domain.

Below, unless otherwise specified or can be inferred from context, curves are in Enclidean space, and curves in Enclidean space are in Cartesian coordinate.
\ssc{Polar curve}
\sssc{Definition}
...
\ssc{Tangent}
\sssc{Definition}
The tangent of a curve at $t$ is $\gamma'(t)$.
\ssc{Arc Length}
\sssc{Definition}
