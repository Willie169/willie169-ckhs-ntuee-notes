...
\bpr
Let $(a_n)_{n\in\bbN}$ be a real sequence. Let
\[i_n=\inf_{k\ge n}a_k\]
$i_n$ is non-decreasing.
...
\[\exists M\in\bbN\colon n\ge M\implies\abs{a_n-L}<\varepsilon\implies L-\varepsilon<a_n<L+\varepsilon\]
\[(n\ge M\implies L-\varepsilon<a_n)\implies L-\varepsilon\le i_n\]
\[(n\ge M\implies a_n<L+\varepsilon)\implies s_n\le L+\varepsilon\]
Thus
\[\exists M\in\bbN\colon n\ge M\implies L-\varepsilon\le i_n\le a_n\le s_n\le L+\varepsilon\]
Thus
