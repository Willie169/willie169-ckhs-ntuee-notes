...
{{{below need generalize or check
...
\sssc{Boundary-value problem (BVP)}C
...
An autonomous first-order ODE is an ODE in the form $\dv{y}{x}=f(y)$.
\sssc{System of autonomous first-order ODEs as dynamical system{{{
