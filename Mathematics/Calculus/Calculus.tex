...
\[\int s\,\mathrm{d}\mu=\int_Es\,\mathrm{d}\mu=\sum_ka_k\int 1_{S_k}\,\mathrm{d}\mu=\sum_ka_k\mu(S_k),\]
...
is finite under the equivalence relation of equality almost everywhere equipped with the norm $\|f(t)\|_{L^p(E;X)}$ for all $f(t)$ in it.
