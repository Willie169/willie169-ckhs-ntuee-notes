...
\begin{proof}
    ...
    \[f((1-\alpha)a+\alpha d)=(1-\alpha)f(a)+\alpha f(d).\]
    Let $x=(1-\alpha)a+\alpha d$.
    \[f(x)-f(a)=\alpha(f(d)-f(a)).\]
    ...
    \[f(x)-f(a)=\alpha(f'(B)\alpha+f'(C)(1-\alpha))(d-a)=f'(B)\alpha (d-a).\]
    \[f'(B)=f'(B)\alpha+f'(C)(1-\alpha).\]
    \[f'(B)=f'(C).\]
    This contradicts the condition that $B<C\implies f'(B)<f'(C)$ for any $a\leq B<C\leq b$.
