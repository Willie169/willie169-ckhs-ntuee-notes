...
\sssc{Double integral}
Let
\[R=\{(r,\theta)\mid a\le r\le b\land\alpha\le\theta\le\beta\}\]
where $0\le a\le b$ and $0\le\beta-\alpha\le 2\pi$. Then,
...
\bit
\item For consine form, the rose is symmetric about $\theta=0$. A petals is the rose restricted to $\theta\in\left.\left[\frac{n\pi}{k}-\frac{\pi}{2},\frac{(n+1)\pi}{k}-\frac{\pi}{2}\right.\right)$ for some $n\in\bbZ$.
