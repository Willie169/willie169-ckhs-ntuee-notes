...
$n$ functions of the same domain and same codomain that is a vector space, $f_1(x),f_2(x),\ldots f_n(x)$, are said to be linearly independent iff
\[\sum_{i=1}^nc_if_i(x)=0\implies\forall i\colon c_i=0.\]
