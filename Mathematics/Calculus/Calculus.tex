...
the $n$th mixed partial derivative function of $y$ or $f$ $m_{i_1}$ times with respect to $x_{i_1}$, $m_{i_1}$ times with respect to $x_{i_2}$, $\dots $, $m_{i_k}$ times with respect to $x_{i_k}$, in which $\sum_{j=1}^km_{i_j}=n$, can be written as
\[\partial_{x_{i_1}x_{i_1}\dots  x_{i_2}x_{i_2}x_{i_2}\dots  x_{i_2}\dots  x_{i_k}x_{i_k}\dots  x_{i_k}}f(\mb{x}),\quad\partial^{(n)}_{\pht{(n)}x_{i_1}x_{i_1}\dots  x_{i_2}x_{i_2}x_{i_2}\dots  x_{i_2}\dots  x_{i_k}x_{i_k}\dots  x_{i_k}}f(\mb{x}),\]
...
A differential of a variable $x$, denoted as $\dd{x}$, is informally defined as an infinitesimal change in $x$.

An equation of differentials of variables
\[f\qty(\mathrm{d}x_1,\mathrm{d}x_2,\ldots\mathrm{d}x_n,x_1,x_2,\ldots x_n)=g\qty(\mathrm{d}x_1,\mathrm{d}x_2,\ldots\mathrm{d}x_n,x_1,x_2,\ldots x_n)\]
is formally defined as "the best linear approximation of the relations among $x_1,x_2,\ldots x_n$
