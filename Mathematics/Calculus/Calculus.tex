...
\[\sqrt{ax^2+bx+c}=\sqrt{|ak|}\sqrt{\operatorname{sgn}(a)\qty(\frac{x}{\sqrt{|k|}}+\frac{h}{\sqrt{|k|}})^2+\operatorname{sgn}(k)},\]
\iten use substitution $u=\frac{x}{\sqrt{|k|}}+\frac{h}{\sqrt{|k|}}$, which makes the integrand,
\[\sqrt{|k|}R\qty(\sqrt{|k|}u-h,\sqrt{|ak|}\sqrt{\operatorname{sgn}(a)u^2+\operatorname{sgn}(k)}),\]
which is a rational function of $u$ and $\sqrt{\operatorname{sgn}(a)u^2+\operatorname{sgn}(k)}$, and,
\item depending on $\operatorname{sgn}(a)$ and $\operatorname{sgn}(k)$,
\bit
...
&=\dv{}{x}\ln(\frac{1+\operatorname{sgn}(x)\sqrt{1+x^2}}{x})\\
&=\frac{x}{1+\operatorname{sgn}(x)\sqrt{1+x^2}}\frac{\frac{\operatorname{sgn}(x)x}{\sqrt{1+x^2}}x-\qty(1+\operatorname{sgn}(x)\sqrt{1+x^2})}{x^2}\\
...
\end{proof}
\sssc{Secant function}
\[\int\sec(x)\dd{x}=\ln|\tan(x)+\sec(x)|+C.\]
\begin{proof}
PLACEHOLDER
\end{proof}
...
\end{proof}
\sssc{$\sqrt{ax^2+bx+c}$}
Let $S=\sqrt{ax^2+bx+c},\quad a>0,\quad b^2-4ac\neq 0$.
PLACEHOLDER
