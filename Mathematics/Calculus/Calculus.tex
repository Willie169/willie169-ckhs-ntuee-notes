...
\ea\]
\end{proof}
\[\int\frac{x^n}{\sqrt{ax+b}}\dd{x}=\frac{2}{a}\qty(x^n\sqrt{ax+b}-n\int x^{n-1}\sqrt{ax+b}\dd{x})=\frac{2}{a(2n+1)}\qty(x^n\sqrt{ax+b}-bn\int \frac{x^{n-1}}{\sqrt{ax+b}}\dd{x}),\quad a\neq 0\land n\in\bbN.\]
\begin{proof}
\[\ba
