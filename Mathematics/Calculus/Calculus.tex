...
\ssc{Polar curve}
\sssc{Definition}
Plane curve in polar coordinate.
...
\sssc{Polar curve}
The arc length of differentiable polar curve $(r(t),\theta(t))$ from $a$ to $b$ is
\[s=\int_a^b\sqrt{\qty(r'(t))^2+\qty(r(t)\theta'(t))^2}\dd{t}.\]
\bpr
\[x(t)=r(t)\cos(\theta(t))\]
\[y(t)=r(t)\sin(\theta(t))\]
\[x'(t)=r'(t)\cos(\theta(t))-r(t)\sin(\theta(t))\theta'(t)\]
\[y(t)=r'(t)\sin(\theta(t))+r(t)\cos(\theta(t))\theta'(t)\]
\[\qty(x'(t))^2+\qty(y'(t))^2=\qty(r'(t))^2+\qty(r'(t))^2+\qty(r(t)\theta'(t))^2\]
\epr
