...
For real-valued functions $f$ and $g$ defined on some interval $[a,\infty)$,
\bit
\item $\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}$ iff $f(x)\in O(g(x))$ and $\abs{g(x)}$ is an asymptotic upper bound of $\abs{f(x)}$.
\item $\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\ge M\abs{g(x)}$ iff $f(x)\in \Omega(g(x))$ and $\abs{g(x)}$ is an asymptotic lower bound of $\abs{f(x)}$.
\item $\exists M_1,M_2>0,T\ge a\colon x\ge T\implies M_1\abs{g(x)}\le\abs{f(x)}\le M_2\abs{g(x)}$ iff $f(x)\in \Theta(g(x))$.
\item $\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}<M\abs{g(x)}$ iff $f(x)\in o(g(x))$.
\item $\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}>M\abs{g(x)}$ iff $f(x)\in \omega(g(x))$.
\eit
...
\[\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}<M\abs{g(x)}\]
\[\exists M_1,M_2>0,U\ge a\colon x\ge U\implies M_1\abs{g(x)}\le\abs{f(x)}\le M_2\abs{g(x)}\]
...
\[\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}<M\abs{g(x)}\]
\[\forall M>0\colon\exists U\ge a\colon x\ge U\implies\abs{f(x)}>M\abs{g(x)}\]
...
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}\]
\[\exists N>0,U\ge a\colon x\ge U\implies\abs{f(x)}\ge N\abs{g(x)}\]
then
\[\exists M,N>0,\max\{T,U\}\ge a\colon x\ge \max\{T,U\}\implies N\abs{g(x)}\le\abs{f(x)}\le M\abs{g(x)}\]

Prove
\[\Theta(g(x))\supseteq O(g(x))\cap\Omega(g(x))\]
\[\exists M_1,M_2>0,T\ge a\colon x\ge T\implies M_1\abs{g(x)}\le\abs{f(x)}\le M_2\abs{g(x)}\]
then
\[\exists M_2>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M_2\abs{g(x)}\]
\[\exists M_1>0,T\ge a\colon x\ge T\implies\abs{f(x)}\ge M_1\abs{g(x)}\]
\epr
...
\[g(x)=1\]
$f\in O(g(x))$:
\[\exists 1>0,1\ge a\colon x\ge 1\implies\abs{f(x)}\le \abs{g(x)}\]
$f\notin o(g(x))$:
\[\forall 1>0,T\ge a\colon\exists x\ge T,x\in\bbQ\colon\abs{f(x)}=\abs{g(x)}\]
$f\notin\Theta(g(x))$:
\[\forall M_1>0,x\ge a,x\notin\bbQ\colon M_1\abs{g(x)}=M_1>\abs{f(x)}=0\]
\epr
...
$f\in \Omega(g(x))$:
\[\exists 1>0,1\ge a\colon x\ge 1\implies\abs{f(x)}\ge \abs{g(x)}\]
$f\notin \omega(g(x))$:
\[\forall 1>0,T\ge a\colon\exists x\ge T,x\in\bbQ\colon\abs{f(x)}=\abs{g(x)}\]
$f\notin\Theta(g(x))$:
\[\forall M_2>0,x\ge a,x\notin\bbQ\colon M_2\abs{g(x)}=0<\abs{f(x)}=1\]
\epr
...
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}\]
then
\[\exists \frac{1}{M}>0,T\ge a\colon x\ge T\implies\abs{g(x)}\ge \frac{1}{M}\abs{g(x)}\]
$\Leftarrow$:
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\ge M\abs{g(x)}\]
then
\[\exists \frac{1}{M}>0,T\ge a\colon x\ge T\implies\abs{g(x)}\le \frac{1}{M}\abs{g(x)}\]
\epr
\[f(x)\in o(g(x))\iff g(x)\in\Omega(f(x))\]
\bpr
$\implies$:
\[\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}<M\abs{g(x)}\]
then
\[\forall \frac{1}{M}>0\colon\exists T\ge a\colon x\ge T\implies\abs{g(x)}>\frac{1}{M}\abs{f(x)}\]
$\Leftarrow$:
\[\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}>M\abs{g(x)}\]
then
\[\forall \frac{1}{M}>0\colon\exists T\ge a\colon x\ge T\implies\abs{g(x)}<\frac{1}{M}\abs{f(x)}\]
...
Transitive:
\[\exists M_1,M_2>0,T\ge a\colon x\ge T\implies M_1\abs{g(x)}\le\abs{f(x)}\le M_2\abs{g(x)}\]
\[\exists N_1,N_2>0,U\ge a\colon x\ge U\implies N_1\abs{h(x)}\le\abs{g(x)}\le N_2\abs{h(x)}\]
then
\[\exists M_1N_1,M_2N_2>0,\max\{T,U\}\ge a\colon x\ge \max\{T,U\}\implies M_1N_1\abs{h(x)}\le\abs{f(x)}\le M_2N_2\abs{h(x)}\]
Reflexive:
\[f(x)\in\Theta(f(x))\]
\[\exists 1,1>0,a\ge a\colon x\ge a\implies 1\abs{f(x)}\le\abs{f(x)}\le 1\abs{f(x)}\]
Symmetric:
\[\exists M_1,M_2>0,T\ge a\colon x\ge T\implies M_1\abs{g(x)}\le\abs{f(x)}\le M_2\abs{g(x)}\]
then
\[\exists \frac{1}{M_2},\frac{1}{M_1}>0,T\ge a\colon x\ge T\implies \frac{1}{M_2}\abs{f(x)}\le\abs{f(x)}\le\frac{1}{M_1}\abs{f(x)}\]
\epr
\item $O(g(x))$ is partial-ordered set with $\Theta$ as $=$.
\bpr
Transitive:
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}\]
\[\exists N>0,U\ge a\colon x\ge U\implies\abs{g(x)}\le N\abs{h(x)}\]
then
\[\exists MN>0,\max\{T,U\}\ge a\colon x\ge\max\{T,U\}\implies\abs{f(x)}\le MN\abs{h(x)}\]
Reflexive:
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}\]
then
\[\exists \frac{1}{M}>0,T\ge a\colon x\ge T\implies\abs{g(x)}\le \frac{1}{M}\abs{f(x)}\]
Antisymmetric:
\[\exists M>0,T\ge a\colon x\ge T\implies\abs{f(x)}\le M\abs{g(x)}\]
\[\exists N>0,U\ge a\colon x\ge U\implies\abs{g(x)}\le N\abs{f(x)}\]
then
\[\exists M,\frac{1}{N}>0,\max\{T,U\}\ge a\colon x\ge \max\{T,U\}\implies\frac{1}{N}\abs{g(x)}\le\abs{f(x)}\le M\abs{g(x)}\]
\epr
...
Transitivity:
\[\forall M>0\colon\exists T\ge a\colon x\ge T\implies\abs{f(x)}<M\abs{g(x)}\]
\[\exists U\ge a\colon x\ge U\implies\abs{g(x)}<\abs{h(x)}\]
then
\[\forall M>0\colon\exists \max\{T,U\}\ge a\colon x\ge \max\{T,U\}\implies\abs{f(x)}<M\abs{h(x)}\]
\epr
