...
Unless otherwise specified, given a property $P$ defined for a function $f(w_1,\ldots,w_n,x,y_1,\ldots,y_n)$ in which $w_1,\ldots,w_n,x,y_1,\ldots,y_n$ are independent variables, we say $f$ is with property $P$ in $x$ if the function $g(w_1,\ldots,w_n,y_1,\ldots,y_n)$ that is defined to map $w_1,\ldots,w_n,y_1,\ldots,y_n$ to $f(w_1,\ldots,w_n,x,y_1,\ldots,y_n)$ for any $w_1,\ldots,w_n,x,y_1,\ldots,y_n$ in the domain of $f$ is with property $P$.
