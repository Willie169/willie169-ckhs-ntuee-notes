...
\ssc{Master Theorem}
\sssc{Master Theorem}
For a positive valued net $T(n)$ defined as
\[T(n)=aT\qty(\frac{n}{b})+f(n)\]
for some constants $a>0$ and $b>1$, and non-negative-valued function $f(n)$, where $\log_ba$ is called critical exponent $c_{crit}$,
\ben
