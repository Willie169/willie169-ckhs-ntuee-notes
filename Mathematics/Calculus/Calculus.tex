...
\ssc{Root mean square (RMS or rms)}
...
For a function $f(t)$ defined on $(T_1,T_2)\neq\varnothing$, the RMS $f_{rms}$ of it is given by:
\[x_{rms}=\sqrt{\frac{1}{T_2-T_1}\int_{-T_1}^{T_2}(f(t))^2\dd{t}}.\]
...
The arithmetic mean of a real-domain function $f$ over an interval $(a,b)\subseteq D_f$ with $a,b\in\bbR$ is defined as
