...
\sssc{Picard–Lindelöf theorem}
If $f(x,y)$ and $\pdv{f}{y}$ are continuous in some neighborhood of $(x_0,y_0)$, then the IVP
\[y'(x)=f(x,y),\quad y(x_0)=y_0\]
has a unique solution in some neighborhood of $x_0$.
