...
\sssc{Indicator function (指示函數或示性函數) or characteristic function (特徵函數)}
An indicator function or a characteristic function of a set $A$ is a function that maps elements of $A$ to 1, and all others to 0, denoted as $1_A$ or $\mb{1}_A$.
\sssc{Permutation}
