...
\sssc{Collection}
A collection or a naive set, sometimes informally called a set or a family, is a collection of different objects. Theses things are called elements or members.
