...
\item The (second-order) induction axiom: If $K$ is a subset of $\mathbb{N}_0$ such that, $0$ is in $K$, and, for every $n\in\mathbb{N}_0$, $n\in K\implies S(n)\in K$, then $\mathbb{N}_0=K$.
\eit
...
\[[(a,b)]=\{(c,d)\in\bbN_0^{\pht{0}2}|(a,b)\sim(c,d)\}.\]
...
\[\abs{[(a,b)]}\coloneq\bcs[(a,b)],\quad&a\ge[(0,0)]\\
[(b,a)],\quad&a<[(0,0)]\ecs.\]
...
An equivalence class of $(a,b)$ is
\[[(a,b)]=\qty\{(c,d)\in\bbZ\times\qty(\bbZ\setminus\{0\})|(a,b)\sim(c,d)\}.\]
...
\[\abs{[(a,b)]}\coloneq\begin{cases}[(a,b)],\quad&a\geq [(0,1)]\\
[(-a,b)],\quad&a\leq [(0,1)]\end{cases}.\]
...
\[\abs{[(x_n)]}\coloneq\begin{cases}[(x_n)],\quad&[(x_n)]\geq [(0)]\\
[(-x_n)],\quad&[(x_n)]\leq [(0)]\end{cases}.\]
