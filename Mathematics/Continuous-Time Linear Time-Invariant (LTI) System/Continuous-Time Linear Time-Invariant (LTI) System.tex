...
\[H_{QD}(i\omega;B,\omega_0)=\frac{\omega_0^{\pht{0}2}}{-\omega^2+iB\omega+\omega_0^{\pht{0}2}}\]
\[\abs{H_{QD}(i\omega;B,\omega_0)}=\frac{\omega_0^{\pht{0}2}}{\sqrt{B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2}}}\]
\[\dv{}{\omega}\qty(\abs{H_{QD}(i\omega;B,\omega_0)})=\frac{-\omega\omega_0^{\pht{0}2}\qty(2\omega^2+B^2-2\omega_0^{\pht{0}2})}{\qty(B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2})^{\frac{3}{2}}}\]
\[\evlv{\dv{}{\omega}\qty(\abs{H_{QD}(i\omega;B,\omega_0)})}_{\omega=\omega_p}=0\]
\[\omega_p=\sqrt{\omega_0^{\pht{0}2}-\frac{B^2}{2}}\]
\[\theta_{QD}(\omega;B,\omega_0)=-\arg(-\omega^2+iB\omega+\omega_0^{\pht{0}2})\]
Asymptotic Bode plot, center, and peak frequencies:
\bit
\item For $\omega\ll\omega_0,B$:
\[\abs{H_{QD}(i\omega;B,\omega_0)}\approx1\]
\[g_{QD}(\omega;B,\omega_0)\approx0\]
which is horizontal asymptote $g_{QD}=0$, i.e., $\abs{H_{QD}}=1$.
\[\theta_{QD}(\omega;B,\omega_0)\approx\frac{\pi}{2}\]
\item For $\omega=\omega_0$:
\[\abs{H_{QD}(i\omega;B,\omega_0)}=\frac{\omega_0}{B}\]
\[g_{QD}(\omega;B,\omega_0)=20\log_{10}(\omega_0)-20\log_{10}(B)\]
\[\theta_{QD}(\omega;B,\omega_0)=-\frac{\pi}{2}\]
\item For $\omega=\omega_p=\sqrt{\omega_0^{\pht{0}2}-\frac{B^2}{2}}$:
\[\abs{H_{QD}(i\omega_p;B,\omega_0)}=\frac{\omega_0^{\pht{0}2}}{\sqrt{B^2\omega_0^{\pht{0}2}-\frac{B^4}{2}+\omega_0^{\pht{0}4}+\frac{B^4}{4}-B^2\omega_0^{\pht{0}2}+\omega_0^{\pht{0}4}-2\omega_0^{\pht{0}4}+B^2\omega_0^{\pht{0}2}}}=\frac{\omega_0}{B\sqrt{1-\frac{B^2}{4\omega_0^{\pht{0}2}}}}\]
\[g_{QD}(\omega;B,\omega_0)=20\log_{10}(\omega_0)-20\log_{10}(B)-10\log_{10}(1-\frac{B^2}{4\omega_0^{\pht{0}2}})\]
\bit
\item $\omega_0>\frac{B}{2}$ overdamped response: $g_{QD}>0$
\item $\omega_0=\frac{B}{2}$ critically damped response: $g_{QD}=0$
\item $\omega_0<\frac{B}{2}$ underdamped response: $g_{QD}<0$
\eit



\item For $\omega\gg\omega_0,B$:
\[\abs{H_{QD}(i\omega;B,\omega_0)}=\frac{\omega_0^{\pht{0}2}}{\omega^2}\]
\[g_{QD}(\omega;B,\omega_0)=40\log_{10}(\omega_0)-40\log_{10}(\omega)\]
which is slant asymptote slope $-40$ dB/dec, $y$ intercept $40\log_{10}(\omega_0)$, and $x$ intercept $\log_{10}(\omega_0)$.
\[\theta_{QD}(\omega;B,\omega_0)=-\pi\]
\eit
