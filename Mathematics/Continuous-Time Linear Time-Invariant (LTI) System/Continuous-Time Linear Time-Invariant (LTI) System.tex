...
Asymptotic Bode plot and important frequencies:
\bit
...
\[\theta_{QD}(\omega;\omega_0,Q)\approx\frac{\pi}{2}\]
\item For $\omega=\omega_0$:
\[\abs{H_{QD}(i\omega;\omega_0,Q)}=Q\]
\[g_{QD}(\omega;\omega_0,Q)=20\log_{10}(Q)\]
\[\theta_{QD}(\omega;\omega_0,Q)=-\frac{\pi}{2}\]
\item For $\omega=\omega_p=\omega_0\sqrt{1-\frac{1}{2Q^2}},\quad Q>\frac{1}{\sqrt{2}}$:
\[\abs{H_{QD}(i\omega;\omega_0,Q)}=\frac{\omega_0^{\pht{0}2}}{\sqrt{\frac{\omega_0^{\pht{0}4}}{Q^2}-\frac{\omega_0^{\pht{0}4}}{2Q^4}+\omega_0^{\pht{0}4}-\frac{\omega_0^{\pht{0}4}}{Q^2}+\frac{\omega_0^{\pht{0}4}}{4Q^4}+\omega_0^{\pht{0}4}-2\omega_0^{\pht{0}4}+\frac{\omega_0^{\pht{0}4}}{Q^2}}}=\frac{Q}{\sqrt{1+\frac{1}{2Q^2}}}\]
\[g_{QD}(\omega;\omega_0,Q)=20\log_{10}(Q)-10\log_{10}(1+\frac{1}{2Q^2})\]
...
\bit
\item $\omega_0>\frac{(2\alpha)}{2}$ overdamped response: $g_{QD}>0$
\item $\omega_0=\frac{(2\alpha)}{2}$ critically damped response: $g_{QD}=0$
\item $\omega_0<\frac{(2\alpha)}{2}$ underdamped response: $g_{QD}<0$
\eit
