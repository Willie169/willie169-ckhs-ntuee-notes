...
\item For $\omega\ll W$:
\[g_{LP}(\omega;W)=0,\]
which is horizontal asymptote $g_{LP}=0$, i.e., $\abs{H_{LP}(i\omega)}=1$.
...
which is horizontal asymptote $g_{HP}=0$, i.e., $\abs{H_{HP}(i\omega)}=1$.
...
which is horizontal asymptote $g_{QD}=0$, i.e., $\abs{H_{QD}(i\omega)}=1$.
...
which has horizontal tangent $g_{QD}=20\log_{10}(\omega_0)-20\log_{10}(B)$, i.e., $\abs{H_{QD}(i\omega)}=\frac{\omega_0}{B}$.
...
which has horizontal tangent $g_{BP}=0$, i.e., $\abs{H_{BP}(i\omega)}=1$.
...
which is horizontal asymptote $g_{BS}=0$, i.e., $\abs{H_{BS}(i\omega)}=1$.
