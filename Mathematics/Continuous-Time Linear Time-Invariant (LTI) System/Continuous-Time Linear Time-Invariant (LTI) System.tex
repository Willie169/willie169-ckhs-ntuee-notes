...
which has slope $-20$ dB/dec, $y$ intercept $20\log_{10}(W)$, and $x$ intercept $\log_{10}(W)$.
...
\item For $\omega\ll W$:
\[g_{LP}(\omega;W)=0,\]
which is horizontal equilibrium $g_{LP}=0$, i.e., $\abs{H(i\omega)}=1$. 
\[\theta_{LP}(\omega;W)\approx-\frac{\pi}{2}.\]
\eit
\sssc{High-pass function}
...
which has slope $20$ dB/dec, $y$ intercept $-20\log_{10}(\omega_c)$, and $x$ intercept $\log_{10}(\omega_c)$.
...
which is horizontal equilibrium $g_{HP}=0$, i.e., $\abs{H(i\omega)}=1$. 
\[\theta_{HP}(\omega;\omega_c)\approx\frac{\pi}{2}-\frac{\pi}{2}=0.\]
\eit
\sssc{Band-pass function}
...
\[\abs{H_{BP}(i\omega;B,\omega_0)}=\frac{B^2\omega^2}{\sqrt{B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}}-2\omega^2\omega_0^{\pht{0}2}}\]
\[\abs{H_{BP}(i\omega;B,\omega_0)}=\frac{B^2\omega^2}{\sqrt{B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2}}}\]
\[g_{BP}(\omega;B,\omega_0)=40\qty(\log_{10}(B)+\log_{10}(\omega))-10\log_{10}(B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2})\]
\[\theta_{BP}(\omega;B,\omega_0)=\frac{\pi}{2}-\arg(-\omega^2+iB\omega+\omega_0^{\pht{0}2})\]
Asymptotic Bode plot and important frequencies:
\bit
\item For $\omega\ll\omega_0-\frac{B}{2}$:
\[g_{BP}(\omega;B,\omega_0)=40\qty(\log_{10}(B)+\log_{10}(\omega))-10\log_{10}(B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2})\]
