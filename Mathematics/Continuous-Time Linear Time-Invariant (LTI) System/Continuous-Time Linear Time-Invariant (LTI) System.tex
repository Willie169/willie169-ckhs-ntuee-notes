...
PLACEHOLDER peak is not omega_0
...
which has horizontal tangent $g_{QD}=20\log_{10}(\omega_0)-20\log_{10}(B)$, i.e., $\abs{H_{QD}}=\frac{\omega_0}{B}$.
\bit
...
\[\dv{\abs{H_{BP}(i\omega;B,\omega_0)}}{\omega}=\frac{B\qty(\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2}+2\omega^3-2\omega\omega_0^{\pht{0}2})}{\qty(B^2\omega^2+\omega^4+\omega_0^{\pht{0}4}-2\omega^2\omega_0^{\pht{0}2})^{\frac{3}{2}}}\]
...
which has horizontal tangent $g_{BP}=0$, i.e., $\abs{H_{BP}}=1$.
