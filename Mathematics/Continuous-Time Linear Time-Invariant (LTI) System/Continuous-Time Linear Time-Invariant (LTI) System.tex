...
\item Changing by 2 times is called an octave or oct, and changing by 10 times is called a decade or dec.
\item Bode plot of magnitude or dB gain curve: Magnitude response plotted in logarithmic (frequency)-logarithmic (magnitude response) scale.
...
\[\theta(\omega;W)=\frac{\pi}{2}\]
Bode plot in magnitude has slope $+20$ dB/decade or $+20\log_{10}(2)\approx +6$ dB/octave, $y$ intercept is $-20\log_{10}(W)$, $x$ intercept is $\log_{10}(W)$.
