...
\eit
\sssc{Inner product is bilinear form}
An inner product is a bililinear form. PLACEHOLDER
\bpr
PLACEHOLDER
\epr
...
\sssc{Standard, unit, or probability simplex}
...
A scalar is a tensor of type $(0,0)$. A vector is a tensor of type $(1,0)$. A covector is a tensor of type $(0,1)$. A matrix as a linear map $V\to V$ is a tensor of type $(1,1)$. A matrix as a bilinear form $V\times V\to\bbR$ is a tensor of type $(0,2)$. A matrix as $V^*\times V^*\to\bbR$ is a tensor of type $\bbR$.
