...
For a set of non-zero vectors \(\{\mathbf{v}_1,\mathbf{v}_2, \dots, \mathbf{v}_n\}\), if the equation:
...
\[\langle y,A(x)\rangle=\langle^tA(y),x\rangle.\]
