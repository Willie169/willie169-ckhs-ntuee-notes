...
Use Frobenius method at $1$.
\[y=\sum_{m=0}^{\infty}a_mx^{m+r}\]
\[y'=\sum_{m=0}^{\infty}a_m(m+r)x^{m+r-1}\]
\[y''=\sum_{m=0}^{\infty}a_m(m+r)(m+r-1)x^{m+r-2}\]
\[\sum_{m=0}^{\infty}a_m(m+r)(m+r-1)x^{m+r-2}-\sum_{m=0}^{\infty}a_m(m+r)(m+r-1)x^{m+r}-2\sum_{m=0}^{\infty}a_m(m+r)x^{m+r}+n(n+1)\sum_{m=0}^{\infty}a_mx^{m+r}=0\]
\[\sum_{m=0}^{\infty}a_m(m+r)(m+r-1)x^{m+r-2}-\sum_{m=0}^{\infty}a_m(m+r)(m+r-1)x^{m+r}-2\sum_{m=0}^{\infty}a_m(m+r)x^{m+r}+n(n+1)\sum_{m=0}^{\infty}a_mx^{m+r}=0\]
\[L=a_0r(r-1)x^{r-2}-a_0r(r-1)x^r-2a_0rx^r+n(n+1)a_0x^r\]
\[I(r)=r(r-1)=0\]
\[r=0\lor1\]
\[y_1(x)=\sum_{m=0}^{\infty}a_m(x-1)^m\]
\[y_2(x)=\sum_{m=0}^{\infty}b_m(x-1)^{m+1}\]
\[y_1'(x)=\sum_{m=1}^{\infty}a_mm(x-1)^{m-1}\]
\[y_1''(x)=\sum_{m=2}^{\infty}a_mm(m-1)(x-1)^{m-2}\]
\[(1-x^2)P_n''(x)-2xP_n'(x)+n(n+1)P_n(x)=0\]
\[\sum_{m=2}^{\infty}a_mm(m-1)(x-1)^{m-2}-\sum_{m=2}^{\infty}a_mm(m-1)(x-1)^m-2\sum_{m=1}^{\infty}a_mm(x-1)^m+n(n+1)\sum_{m=0}^{\infty}a_m(x-1)^m=0\]
\[2a_2+n(n+1)a_0+(6a_3-2a_1+n(n+1)a_1)(x-1)+\sum_{m=2}^{\infty}(a_{m+2}(m+2)(m+1)-a_m(m+1)+n(n+1)a_m)(x-1)^m=0\]
...
\[a_{m-2}=-\frac{(m-1)m}{(n-m-2)(n+m-1)}a_m\]
