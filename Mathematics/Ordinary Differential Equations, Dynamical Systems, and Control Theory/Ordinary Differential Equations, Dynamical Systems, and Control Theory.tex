...
\(\pm 1\) are two regular singular points. Use power series method at 0.
...
For odd $n$, take
\[a_1=(-1)^{\frac{n-1}{2}}\frac{\prod_{i=1}^{\frac{n+1}{2}}(2i-1)}{\prod_{i=1}^{\frac{n-1}{2}}(2i)}=(-1)^{\frac{n-1}{2}}\frac{n!}{2^{n-1}\qty(\qty(\frac{n-1}{2})!)^2}\]
