...
\ssc{Homogeneity}
A linear ODE is called a linear homgeneous ODE iff the forcing term is 0 for all $x$; otherwise, it is called a linear nonhomogeneous ODE. The associated homogeneous equation of a nonhomogeneous equation is it with forcing term replaced with 0.
