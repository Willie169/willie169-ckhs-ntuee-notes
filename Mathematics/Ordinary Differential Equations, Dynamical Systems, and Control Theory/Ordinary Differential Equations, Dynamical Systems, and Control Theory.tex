...
\[a_{2m}=-\frac{\prod_{i=0}^m(n-i)(n+i+1)}{(2m)!}a_0,\quad m\in\bbN\]
\[a_{2m+1}=-\frac{\prod_{i=1}^m(n-i)(n+i+1)}{(2m+1)!}a_1,\quad m\in\bbN\]
When $n$ is even $a_{2m}$ terminates at $m=n$. When $n$ is odd $a_{2m+1}$ terminates at $m=n$. These yield the polynomial solutions.

For even $n$, take
\[a_0=(-1)^{\frac{n}{2}}\frac{\prod_{i=1}^{\frac{n}{2}}(2i-1)}{\prod_{i=1}^{\frac{n}{2}}(2i)}\]
\[a_{2m}=(-1)^{\frac{n}{2}+1}\frac{\prod_{i=0}^m(n-i)(n+i+1)}{(2m)!}\frac{\prod_{i=1}^{\frac{n}{2}}(2i-1)}{\prod_{i=1}^{\frac{n}{2}}(2i)},\quad m\in\bbN\]
