...
If a first-order theory has an infinite model $\mathcal{M}$ of some cardinality, then it has models of all smaller infinite cardinalities down to the cardinality of its language that are substructures of $\mathcal{M}$.
\sssc{Upward Löwenheim–Skolem Theorem}
If a first-order theory has an infinite model $\mathcal{M}$ of some cardinality, then it has models of all larger cardinalities that are superstructure of $\mathcal{M}$.
...
For an abstract logic $(L,\mathscr{M})$, if for every theory $T$ over $L$ that has an infinite model $\mathcal{M}\in\mathscr{M}$ of some cardinality, then it has models in $\mathscr{M}$ of all smaller infinite cardinalities down to the cardinality of its language that are substructures of $\mathcal{M}$, then the abstract logic has downward Löwenheim–Skolem property.
\sssc{Upward Löwenheim–Skolem Theorem}
For an abstract logic $(L,\mathscr{M})$, if for every theory $T$ over $L$ that has an infinite model $\mathcal{M}\in\mathscr{M}$ of some cardinality, then it has models in $\mathscr{M}$ of all larger cardinalities that are superstructures of $\mathcal{M}$, then the abstract logic has upward Löwenheim–Skolem property.
