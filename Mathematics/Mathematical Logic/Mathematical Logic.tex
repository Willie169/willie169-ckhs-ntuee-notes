...
For a theory $T$ over language $\mathcal{L}$, a deductive system that $T=\{P\in\mathcal{L}\mid\vdash P\}$ is called to generate $T$ and is usually not distinguished with $T$.
\sssc{(Syntactical) consistency}
