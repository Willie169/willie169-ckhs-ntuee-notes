...
\item a set of atomic propositions, atomic formulas, atomic sentences, atoms, proposition letters, sentence letters, propositional variables, or variables $\mathcal{P}$ with $\mathcal{P}\cap\mathcal{O}=\varnothing$ and $\mathcal{O}\cup\mathcal{P}$ be the alphabet of $\mathcal{L}$,
\eit
