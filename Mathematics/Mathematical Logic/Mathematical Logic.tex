...
If a first-order theory has an infinite model $\mathcal{M}$ of some cardinality, then it has models of all larger cardinalities that are extensions of $\mathcal{M}$.
