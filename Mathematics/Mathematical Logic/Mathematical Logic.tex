...
Compactness property implies that for any theory has model in $\mathscr{M}$, there exists a sound deductive system that derive it.

That for any theory of a model in $\mathscr{M}$, there exists a sound and semantically complete deductive system that derive it, implies compactness property.
