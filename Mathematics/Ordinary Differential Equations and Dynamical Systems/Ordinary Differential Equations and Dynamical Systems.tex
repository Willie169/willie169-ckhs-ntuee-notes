...
Solutions:
PLACEHOLDER
\[A_1=-A_0,\quad B_0=3A_0,\]
\[A_{n+2}(2n+3)+B_{n+2}(n+2)(n+1)-2A_{n+1}-B_{n+1}(2n+1)+A_n+B_nn=0.\]
\begin{proof}
...
\[y_2''(x)=\ln|x|\sum_{n=0}^{\infty}A_nn(n-1)x^{n-2}+\sum_{n=0}^{\infty}A_n(2n-1)x^{n-2}+\sum_{n=0}^{\infty}B_nn(n-1)x^{n-2}\]
...
\[\ln|x|\sum_{n=0}^{\infty}A_nn(n-1)x^{n-1}+\sum_{n=0}^{\infty}A_n(2n-1)x^{n-1}+\sum_{n=0}^{\infty}B_nn(n-1)x^{n-1}+\ln|x|\sum_{n=0}^{\infty}A_nnx^{n+1}+\sum_{n=0}^{\infty}A_nx^{n+1}+\sum_{n=0}^{\infty}B_nnx^{n+1}-2\ln|x|\sum_{n=0}^{\infty}A_nnx^n-2\sum_{n=0}^{\infty}A_nx^n-2\sum_{n=0}^{\infty}B_nnx^n+\ln|x|\sum_{n=0}^{\infty}A_nx^n+\sum_{n=0}^{\infty}B_nx^n=0\]
\[\sum_{n=0}^{\infty}A_n(2n-1)x^{n-1}+B_nn(n-1)x^{n-1}+A_nx^{n+1}+B_nnx^{n+1}-2A_nx^n-B_n(2n-1)x^n=0\]
\[\sum_{n=0}^{\infty}A_n(2n-1)x^{n-1}+B_nn(n-1)x^{n-1}-\sum_{n=1}^{\infty}2A_{n-1}x^{n-1}+B_{n-1}(2n-3)x^{n-1}+\sum_{n=2}^{\infty}A_{n-2}x^{n-1}+B_{n-2}(n-2)x^{n-1}=0\]
\[-A_0x^{-1}+A_1-2A_0+B_0+\sum_{n=2}^{\infty}\qty(A_n(2n-1)+B_nn(n-1)-2A_{n-1}-B_{n-1}(2n-3)+A_{n-2}+B_{n-2}(n-2))x^{n-1}=0\]
\[A_1-2A_0+B_0=0,\quad B_0=3A_0\]
\[A_{n+2}(2n+3)+B_{n+2}(n+2)(n+1)-2A_{n+1}-B_{n+1}(2n+1)+A_n+B_nn=0\]
PLACEHOLDER
