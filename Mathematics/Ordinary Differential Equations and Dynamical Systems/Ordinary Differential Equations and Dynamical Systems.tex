...
\ben
\item The power series method seeks a solution for all ordinary points $x\neq x_0$ in the form
...
\item The family general solutions for all ordinary points $x\neq x_0$ is:
\[y=C\sum_{n=0}^{\infty}a_n(x-x_0)^n,\quad C,a_n\in\bbR.\]
Substitute it into the ODE and solve it to obtain a recurrence relation for $a_n$.
\een
...
\ben
\item The Frobenius method seeks a solution for all ordinary points and regular singular points $x\neq x_0$ in the form
...
\bit
\item Case $r_1-r_2\notin\bbZ\land r_1,r_2\in\bbR$: Two linearly independent solutions for all ordinary points and regular singular points $x\neq x_0$ are:
...
\item Case $r_1,r_2$ are conjugate imaginary roots: Let $r_1,r_2=\alpha\pm\beta i$. Two linearly independent solutions for all ordinary points and regular singular points $x\neq x_0$ are:
...
\item Case $r_1-r_2\in\bbN_0$: Two linearly independent solutions for all ordinary points and regular singular points $x\neq x_0$ are:
\[y_1(x)=(x-x_0)^{r_1}\sum_{n=0}^{\infty}A_n(x-x_0)^n,\quad A_0\neq 0\land A_n\in\bbR,\]
\[y_2(x)=y_1(x)\ln(x-x_0)+(x-x_0)^{r_2}\sum_{n=0}^{\infty}B_n(x-x_0)^n,\quad B_0\neq 0\land B_n\in\bbR.\]
\eit 
\item Substitute them into the ODE and solve them respectively to obtain recurrence relations for $A_n$ and $B_n$. The family of general solutions for all ordinary points and regular singular points $x\neq x_0$ is:
