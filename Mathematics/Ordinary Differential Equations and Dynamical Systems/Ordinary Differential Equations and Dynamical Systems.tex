...
\item Solve for the recurrence relation of $a_n$.
...
\item Solve for the recurrence relations of $A_n$ and $B_n$. The term with $\ln|x-x_0|$ of $y_2(x)$ substitution in Case $r_1-r_2\in\bbN_0$ can be ignored since solving it will get the same recurrence relations of $A_n$ as that of $y_1(x)$ substitution.
...
\[y_2''(x)=\ln|x|\sum_{n=0}^{\infty}A_nn(n-1)x^{n-2}+\sum_{n=0}^{\infty}A_nnx^{n-2}+\sum_{n=0}^{\infty}B_nn(n-1)x^{n-2}\]
\[xy_2''(x)=\ln|x|\sum_{n=0}^{\infty}A_nn(n-1)x^{n-1}+\sum_{n=0}^{\infty}A_nnx^{n-1}+\sum_{n=0}^{\infty}B_nn(n-1)x^{n-1}\]
...
\[\ln|x|\sum_{n=0}^{\infty}A_nn(n-1)x^{n-1}+\sum_{n=0}^{\infty}A_nnx^{n-1}+\sum_{n=0}^{\infty}B_nn(n-1)x^{n-1}+\ln|x|\sum_{n=0}^{\infty}A_nnx^{n+1}+\sum_{n=0}^{\infty}A_nx^{n+1}+\sum_{n=0}^{\infty}B_nnx^{n+1}-2\ln|x|\sum_{n=0}^{\infty}A_nnx^n-2\sum_{n=0}^{\infty}A_nx^n-2\sum_{n=0}^{\infty}B_nnx^n+\ln|x|\sum_{n=0}^{\infty}A_nnx^{n-1}+\sum_{n=0}^{\infty}A_nx^{n-1}+\sum_{n=0}^{\infty}B_nnx^{n-1}+\ln|x|\sum_{n=0}^{\infty}A_nx^n+\sum_{n=0}^{\infty}B_nx^n=0\]
\[\ln|x|A_{n+1}(n+1)n+A_{n+1}(n+1)+B_{n+1}(n+1)n+\ln|x|A_{n-1}(n-1)+A_{n-1}+B_{n-1}(n-1)-2\ln|x|A_nn-2A_n-2B_nn+\ln|x|A_{n+1}(n+1)+A_{n+1}+B_{n+1}(n+1)+\ln|x|A_n+B_n=0\]
\[A_{n+1}(n+1)+B_{n+1}(n+1)n+A_{n-1}+B_{n-1}(n-1)-2A_n-2B_nn+A_{n+1}+B_{n+1}(n+1)+B_n=0\]
\[A_{n+2}(n+1)+B_{n+2}(n+2)^2-2A_{n+1}-B_{n+1}(2n+1)+A_n+B_nn=0\]
\[y(x)=C_1y_1(x)+C_2y_2(x)=C_1\sum_{n=0}^{\infty}A_nx^n+C_2\ln|x|\sum_{n=0}^{\infty}A_nx^n+C_2\sum_{n=0}^{\infty}B_nx^n\]
PLACEHOLDER
\end{proof}
