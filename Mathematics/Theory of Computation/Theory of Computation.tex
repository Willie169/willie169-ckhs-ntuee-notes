...
A set $S$ is computably enumerable (c.e.), recursively enumerable (r.e.), semidecidable, partially decidable, listable, provable or Turing-recognizable is there exists a Turin machine whose set of accepted final states is $S$.
