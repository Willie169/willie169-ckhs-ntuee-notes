...
The resultant beam of two beams with electric field amplitudes $A,B$, intensities $I_A=\frac{\varepsilon c}{2}A^2$ and $I_B=\frac{\varepsilon c}{2}B^2$, and phase angle difference $\delta$ has amplitude phasor $\calC$:
\[\calC=A+Be^{i\delta},\]
amplitude $C$
