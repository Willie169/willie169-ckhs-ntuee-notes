...
我們常以一直線，中一面鏡或透鏡垂直之，來圖像推導成像。Extended object 一般畫為一垂直直線、指向一方向的箭頭，對於點光源常畫作與之等高。一點或平行光源，可置於一處，ray tracing 繪製自光源的 rays，射到 extended object 頂與底、鏡中等位置，以 ray 間的相交處得到像等。
\subsection{平面鏡（Plane mirror）}
\sssc{Image}
For a plane mirror, the image is a virtual image of the same size of the object at the opposite of the mirror in the same distance to the mirror as the object.
