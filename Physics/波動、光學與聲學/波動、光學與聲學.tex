...
Suppose a region with spherical surface of curvature radius $R$ whose center of curvature is on the main axis has refractive index $n_2$. Suppose the medium in front of it has refractive index $n_1$. An object has height $h_o\gtrapprox0$ (paraxial) relative to the main axis and distance $u$ relative to the spherical surface. Let the image of it in the region has image height $h_i$ with upward being positive and downward being negative and image distance $v$ relative to the spherical surface with real image being positive and virtual image being negative.
