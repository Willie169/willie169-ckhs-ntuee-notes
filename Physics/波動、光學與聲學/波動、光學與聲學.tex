...
\[\left\langle\dv{K}{t}\right\rangle=\frac{1}{4}\mu vA^2\omega^2\]
\begin{proof}
...
\[\left\langle\dv{K}{t}\right\rangle=\dv{K}{x}\dv{x}{t}=\frac{1}{2}\mu vA^2\omega^2\frac{\omega}{2\pi}\int_0^{\frac{2\pi}{\omega}}\cos^2(kx-\omega t)\dd{t}=\frac{1}{2}\mu vA^2\omega^2\frac{\omega}{2\pi}\frac{\pi}{\omega}=\frac{1}{4}\mu vA^2\omega^2\]
\end{proof}
\subsection{反射與透射}
繩波是一維波，必為垂直入射。
