...
For a system $S$ of continuous mass distribution with (mass) density $\rho(\mb{r})$, the (position of) center of mass $\mb{r}$
\[\mb{r}=\frac{\int_S\mb{r}\rho(\mb{r})\dd{V}}{\int\rho(\mb{r})\dd{V}}.\]
\sssc{向量}
\bit
...
\[U=\frac{k^2}{2}.\]
\sssc{楊氏模量/楊氏模數（Young's modulus or Young modulus）}
