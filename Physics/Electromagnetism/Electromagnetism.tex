...
Capacitance:
\[C=2\pi\varepsilon L\ln(\frac{a}{b})\]
...
A spherical metal shell with radius $R$ and charge $q$ filled with dielectric medium with permittivity $\varepsilon$. Let its center be the origin.
