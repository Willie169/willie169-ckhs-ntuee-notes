...
\[\ba
\mb{E}&=\int_0^{2\pi R}\frac{zq\hat{k}}{8\pi^2\vepsilon_0R(z^2+R^2)^{3/2}}\dd{s}\\
&=\frac{zq\hat{k}}{4\pi\vepsilon_0(z^2+R^2)^{3/2}}
\ea\]
For $z\ll R$,
\[\mb{E}=\frac{zq\hat{k}}{4\pi\vepsilon_0R^3}\]
For $z\gg R$,
\[\mb{E}=\frac{q\hat{k}}{4\pi\vepsilon_0z^2}\]
\sssc{Electric field of a uniformly charged disk}
Consider a disk of radius $R$ lying in the $xy$-plane, centered at the origin, with total charge $q$ uniformly distributed. At $(0,0,z)$, the electric field is
\[\ba
\mb{E}&=\int_0^{2\pi}\int_0^R\frac{zq\hat{k}}{4\pi^2\vepsilon_0R^2(z^2+r^2)^{3/2}}r\dd{r}\dd{\theta}\\
&=\int_0^{2\pi}\evlp(-\frac{zq\hat{k}}{4\pi^2\vepsilon_0R^2(z^2+r^2)^{1/2}})_0^R\dd{\theta}\\
&=\int_0^{2\pi}\frac{q\hat{k}}{4\pi^2\vepsilon_0R^2}-\frac{zq\hat{k}}{4\pi^2\vepsilon_0R^2(z^2+R^2)^{1/2}}\dd{\theta}\\
