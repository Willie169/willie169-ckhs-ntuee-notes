...
\sssc{Electric field of a uniformly charged rod}
At the point at a distance $d$ from one of the endpoint of the rod with length $\ell$ on the plane containing the endpoint perpendicular to the rod
\[\mb{E}=\frac{q}{4\pi\vepsilon_0\ell}\int_0^{\ell}\frac{d}{(x^2+d^2)^{3/2}}\dd{x}=\frac{q}{4\pi\vepsilon_0 d\sqrt{\ell^2+d^2}}\]
...
&=\oint_lI\dd{\m{l}}\times(\qty(\mb{r}\cdot\nabla)\mb{B}\\
&=\nabla(\mb{m}\cdot\mb{B})
\ea\]
\epr
\[\tau=\mb{m}\times\mb{B}\]
...
\item 玻爾磁子（Bohr magneton）：$\mu_B=\frac{e\hbar}{2m_e}\pporox 9.27\times 10^{-24}$ J/T
\end{itemize}
