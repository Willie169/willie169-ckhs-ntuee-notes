...
A uniform rigid hoop with any thickness of mass $M$ and radius $R$ has moment of inertia $I$ about its central axis:
\[I=MR^2.\]
\sssc{Moment of inertia of a hoop about any axis passing through its center of mass and perpendicular to its central axis}
A uniform rigid hoop with any thickness of mass $M$ and radius $R$ has moment of inertia $I$ about any axis passing through its center of mass and perpendicular to its central axis:
\[I=\frac{M}{2}R^2.\]
\begin{proof}
\[\ba
I&=2\int_0^{\pi}R^2\sin^2\theta M\frac{\dd{\theta}}{2\pi}\\
&=\frac{MR^2}{\pi}\qty(\frac{\theta}{2}-\frac{\sin(2\theta)}{4})_\big\vert_0^{\pi}\\
&=\frac{M}{2}R^2
\ea\]
\end{proof}
