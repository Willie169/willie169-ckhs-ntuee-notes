...
\sssc{Characteristic length (特徵長度) and characteristic speed (特徵速率)}
...
\sssc{Viscosity (黏度/黏滯性) of Newtonian fluid (牛頓流體)}
...
指加速度恆定之運動。令加速度恆為$\mathbf{a}$，初位置$\mathbf{x}_0$，初速度$\mathbf{v}_0$，則位置為
