...
\sssc{終端速度（Terminal velocity）/極限速度（limiting velocity）}
The terminal velocity or limiting velocity is the speed of any system subjected to a usually constant force and a velocity-dependent resistance force such that the two forces balance. Let the velocity of the system be $\mathbf{v}$, the constant force be $\mathbf{F}_C$ and parallel to $\mathbf{v}$, and the resistance force $\mathbf{F}_D$ obey:
...
\sssc{Moment of inertia of a hoop about its central axis}
...
\[I=MR^2.\]
\sssc{Moment of inertia of a hoop about any axis passing through its center of mass and perpendicular to its central axis}
...
\end{proof}
\sssc{Moment of inertia of a disk about its central axis}
A uniform rigid infinitely thin disk of mass $M$ and radius $R$ has moment of inertia $I$ about its central axis:
\[I=\frac{MR^2}{2}.\]
\begin{proof}
\[\ba
I&=\frac{M}{\pi R^2}\int_0^Rr^22\pi r\dd{r}\\
&=\frac{2M}{R^2}\int_0^Rr^3\dd{r}\\
&=\frac{MR^2}{2}
\ea\]
\end{proof}
\sssc{Moment of inertia of a disk about any axis passing through its center of mass and perpendicular to its central axis}
A uniform rigid infinitely thin disk of mass $M$ and radius $R$ has moment of inertia $I$ about any axis passing through its center of mass and perpendicular to its central axis:
\[I=\frac{MR^2}{4}.\]
\begin{proof}
By perpendicular axis theorem and the symmetry of the object, $2I=\frac{MR^2}{2}$.
\end{proof}
\sssc{Moment of inertia of a cylinder about its central axis}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a cylinder about any axis passing through its center of mass and perpendicular to its central axis}
A uniform rigid cylinder of mass $M$, radius $R$, and lenght $L$ has moment of inertia $I$ about any axis passing through its center of mass and perpendicular to its central axis:
\[I=\frac{M}{12}\qty(3R^2+L^2).\]
\begin{proof}
For $R>0$:
\[\ba
I&=\frac{2M}{\pi R^2L}\int_0^{\frac{L}{2}}\int_0^R\int_0^{2\pi}(r^2\sin^2\theta+l^2)r\dd{\theta}\dd{r}\dd{l}\\
&=\frac{2M}{\pi R^2L}\int_0^{\frac{L}{2}}\int_0^R\qty(r^3\qty(\frac{\theta}{2}-\frac{\sin(2\theta)}{4})+l^2r\theta)\big\vert_0^{2\pi}\dd{r}\dd{l}\\
&=\frac{2M}{\pi R^2L}\int_0^{\frac{L}{2}}\int_0^R\qty(\pi r^3+2\pi l^2r)\dd{r}\dd{l}\\
&=\frac{2M}{R^2L}\int_0^{\frac{L}{2}}\frac{R^4}{4}+l^2R^2\dd{l}\\
&=\frac{2M}{L}\int_0^{\frac{L}{2}}\frac{R^2}{4}+l^2\dd{l}\\
&=\frac{2M}{L}\qty(\frac{R^2L}{8}+\frac{L^3}{24})\\
&=\frac{M}{12}\qty(3R^2+L^2)
\ea\]
For $R=0$:
\[\ba
I&=2\int_0^{\frac{L}{2}}l^2\frac{M}{L}\dd{l}\\
&=\frac{2M}{L}\frac{L^3}{24}\\
&=\frac{ML^2}{12}
\ea\]
\end{proof}
\sssc{Moment of inertia of a spherical shell about any axis passing through its center of mass}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a sphere about any axis passing through its center of mass}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a cuboid about axis passing through its center of mass and perpendicular to its surface}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a cone about its central axis}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a cone about any axis passing through its center of mass and perpendicular to its central axis}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a hollow cone about its central axis}
...
\ea\]
\end{proof}
\sssc{Moment of inertia of a hollow cone about any axis passing through its center of mass and perpendicular to its central axis}
...
若系統各處重力場相同則系統重心即質心。
\sssc{General Relativity,  general theory of relativity, or Einstein's theory of gravity}
...
均勻重力加速度量值$g$下，一平面直角座標使得$x$軸在地面上、重力加速度$(0,-g)$，一高度不計物體初位置$(0,h)$、$t=0$時以仰角$\theta=\arctan\frac{v_y}{v_x}$，速率$v=\sqrt{v_x^{\pht{x}2}+v_y^{\pht{y}2}}$斜拋/發射（projectile）而出，即初速度$(v_x,v_y)=(v\sin\theta,v\cos\theta)$，落地（即$y=0$）前位置$\mathbf{r}$：
...
&=\frac{v}{g}\frac{\sqrt{v^2+2gh}}{2\qty(v^2+gh)}\qty(\pm v^2+v^2+2gh)
\ea\]
$\pm$取正較大。
\[\ba
R\qty(\frac{v}{\sqrt{2\qty(v^2+gh)}})&=\frac{v}{g}\frac{\sqrt{v^2+2gh}}{2\qty(v^2+gh)}\qty(2v^2+2gh)\\
&=\frac{v\sqrt{v^2+2gh}}{g}
\ea\]
\end{proof}
若$h=0$，則到達地面時：
\[t=\frac{2v_y}{g}\]
...
\sssc{角簡諧運動（Angular simple harmonic motion, angular SHM）/扭擺（Torsion pendulum）}
...
\sssc{簡單單擺（Simple pendulum）小角度近似為角簡諧運動}
...
\item $u=0$：靜止於$(R,0)$。
\eit
\sssc{Forced Oscillations and Resonance}
If an external driving force with angular frequency $\omega_d$ acts on an oscillating system with natural angular frequency $\omega$, the system oscillates with angular frequency $\omega_d$. The velocity amplitude of the system is greatest when
\[\omega_d=\omega,\]
a condition called resonance. The amplitude of the system is approximately greatest under the same condition.
\end{document}
