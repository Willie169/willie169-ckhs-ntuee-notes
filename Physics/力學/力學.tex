...
\begin{proof}
\[\ba
I&=\int_0^Rr^2M\frac{2\pi r\dd{r}}{\pi R^2}\\
...
For $R>0$:
\[\ba
I&=2\int_0^{\frac{L}{2}}\int_0^R\int_0^{2\pi}(r^2\sin^2\theta+l^2)M\frac{r\dd{\theta}\dd{r}\dd{l}}{\pi R^2L}\\
&=\frac{2M}{\pi R^2L}\int_0^{\frac{L}{2}}\int_0^R\int_0^{2\pi}(r^2\sin^2\theta+l^2)r\dd{\theta}\dd{r}\dd{l}\\
...
\begin{proof}
\[\ba
I&=\int_0^{\pi}\int_0^{2\pi}R^2\sin^2\theta M\frac{R^2\sin\theta\dd{\phi}\dd{\theta}}{4\pi R^2}\\
...
\[\tan\theta\]
\begin{proof}
\[R(\theta)=\frac{v\cos\theta}{g}\qty(v\sin\theta+\sqrt{v^2\sin^2\theta+2gh})\]
\[R'(\theta)=-\frac{v\sin\theta}{g}\qty(v\sin\theta+\sqrt{v^2\sin^2\theta+2gh})+\frac{v\cos\theta}{g}\qty(v\cos\theta+\frac{v^2\sin\theta\cos\theta}{\sqrt{v^2\sin^2\theta+2gh}})\]
\[R'(\theta)=0\Rightarrow\]
\[s\coloneq\sin\theta,\quad c\coloneq\cos\theta,\quad S\coloneq\sqrt{v^2s^2+2gh}\]
\[R'(\theta)=-\frac{vs}{g}\qty(vs+S)+\frac{vc}{g}\qty(vc+\frac{v^2sc}{S})\]
\[R'(\theta)=0\Rightarrow\]
\[sS\qty(vs+S)=c\qty(vcS+v^2sc)\]
\[v^2s^3-2ghs=v\qty(c^2-s^2)S+v^2s\qty(1-s^2)\]
\[-v^2s\qty(1-2s^2)-2ghs=v\qty(1-2s^2)S\]
\[v^4s^2\qty(1-2s^2)^2+(2gh)^2s^2+4ghv^2s^2\qty(1-2s^2)=v^2\qty(1-2s^2)^2\qty(v^2s^2+2gh)\]
\[2ghs^2+2v^2s^2\qty(1-2s^2)=v^2\qty(1-2s^2)^2\]
\[2ghs^2=v^2\qty(1-6s^2+8s^4)\]
\[u\coloneq s^2\]
\[8v^2u^2-\qty(6v^2+2gh)u+v^2=0\]
\[\ba
u&=\frac{6v^2+2gh\pm\sqrt{\qty(6v^2+2gh)^2-32v^4}}{16v^2}\\
&=\frac{3v^2+2gh\pm\sqrt{v^4+6ghv^2+g^2h^2}}{8v^2}\\
